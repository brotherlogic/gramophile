...
func (c *gramophileEServiceClient) RefreshWant(ctx context.Context, in *RefreshWantRequest, opts ...grpc.CallOption) (*RefreshWantResponse, error) {
	...
	err := c.cc.Invoke(ctx, GramophileEService_RefreshWant_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gramophileEServiceClient) AddRecord(ctx context.Context, in *AddRecordRequest, opts ...grpc.CallOption) (*AddRecordResponse, error) {
	...
	err := c.cc.Invoke(ctx, GramophileEService_AddRecord_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
