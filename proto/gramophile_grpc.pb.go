...
func (c *gramophileEServiceClient) RefreshWant(ctx context.Context, in *RefreshWantRequest, opts ...grpc.CallOption) (*RefreshWantResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gramophile.GramophileEService/RefreshWant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gramophileEServiceClient) DeleteWantlist(ctx context.Context, in *DeleteWantlistRequest, opts ...grpc.CallOption) (*DeleteWantlistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gramophile.GramophileEService/DeleteWantlist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gramophileEServiceClient) GetSale(ctx context.Context, in *GetSaleRequest, opts ...grpc.CallOption) (*GetSaleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gramophile.GramophileEService/GetSale", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gramophileEServiceClient) GetStats(ctx context.Context, in *GetStatsRequest, opts ...grpc.CallOption) (*GetStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gramophile.GramophileEService/GetStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GramophileEService_RefreshWant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gramophile.GramophileEService/RefreshWant",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GramophileEService_DeleteWantlist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gramophile.GramophileEService/DeleteWantlist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GramophileEService_GetSale_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gramophile.GramophileEService/GetSale",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GramophileEService_GetStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gramophile.GramophileEService/GetStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
