...
var file_config_proto_rawDesc = []byte{
	...
	0x99, 0x01, 0x0a, 0x0b, 0x57, 0x61, 0x6e, 0x74, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	...
	0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x2a, 0x24, 0x0a, 0x05, 0x42,
	...
	0x5f, 0x4c, 0x49, 0x53, 0x54, 0x10, 0x02, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_config_proto_goTypes = []interface{}{
	...
	(*Filter)(nil),             // 12: gramophile.Filter
	(*MoveCriteria)(nil),       // 13: gramophile.MoveCriteria
	(*ValidationCriteria)(nil), // 14: gramophile.ValidationCriteria
	(*ValidationRule)(nil),     // 15: gramophile.ValidationRule
	(*FolderMove)(nil),         // 16: gramophile.FolderMove
	(*MoveQuota)(nil),          // 17: gramophile.MoveQuota
	(*MoveHistory)(nil),        // 18: gramophile.MoveHistory
...
var file_config_proto_depIdxs = []int32{
	...
	12, // 5: gramophile.ValidationRule.validation_filter:type_name -> gramophile.Filter
	14, // 6: gramophile.ValidationRule.validation_criteria:type_name -> gramophile.ValidationCriteria
	4,  // 7: gramophile.ValidationRule.validation_strategy:type_name -> gramophile.ValidationStrategy
	13, // 8: gramophile.FolderMove.criteria:type_name -> gramophile.MoveCriteria
	...
	18, // 11: gramophile.MoveQuota.past_moves:type_name -> gramophile.MoveHistory
	...
	12, // 15: gramophile.CleaningConfig.applies_to:type_name -> gramophile.Filter
	...
	12, // 19: gramophile.ListenFilter.filter:type_name -> gramophile.Filter
	...
	16, // 35: gramophile.GramophileConfig.moves:type_name -> gramophile.FolderMove
	15, // 36: gramophile.GramophileConfig.validations:type_name -> gramophile.ValidationRule
