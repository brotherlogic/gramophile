...
var file_config_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x67, 0x72, 0x61, 0x6d,
	0x6f, 0x70, 0x68, 0x69, 0x6c, 0x65, 0x2e, 0x4d, 0x61, 0x6e, 0x64, 0x61, 0x74, 0x65, 0x52, 0x07,
	0x6d, 0x61, 0x6e, 0x64, 0x61, 0x74, 0x65, 0x22, 0x97, 0x02, 0x0a, 0x0a, 0x53, 0x61, 0x6c, 0x65,
	...
	0x6e, 0x22, 0x3b, 0x0a, 0x0a, 0x4b, 0x65, 0x65, 0x70, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	...
	0x6e, 0x64, 0x61, 0x74, 0x65, 0x52, 0x07, 0x6d, 0x61, 0x6e, 0x64, 0x61, 0x74, 0x65, 0x22, 0x3d,
	0x0a, 0x0b, 0x57, 0x61, 0x6e, 0x74, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x2e, 0x0a,
	...
	0x42, 0x61, 0x73, 0x69, 0x73, 0x52, 0x06, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x2a, 0x24, 0x0a,
	...
	0x5f, 0x54, 0x4f, 0x5f, 0x4d, 0x45, 0x44, 0x49, 0x41, 0x4e, 0x10, 0x02, 0x2a, 0x47, 0x0a, 0x0a,
	0x57, 0x61, 0x6e, 0x74, 0x73, 0x42, 0x61, 0x73, 0x69, 0x73, 0x12, 0x11, 0x0a, 0x0d, 0x57, 0x41,
	0x4e, 0x54, 0x53, 0x5f, 0x44, 0x49, 0x53, 0x43, 0x4f, 0x47, 0x53, 0x10, 0x00, 0x12, 0x10, 0x0a,
	0x0c, 0x57, 0x41, 0x4e, 0x54, 0x53, 0x5f, 0x48, 0x59, 0x42, 0x52, 0x49, 0x44, 0x10, 0x01, 0x12,
	0x14, 0x0a, 0x10, 0x57, 0x41, 0x4e, 0x54, 0x53, 0x5f, 0x47, 0x52, 0x41, 0x4d, 0x4f, 0x50, 0x48,
	0x49, 0x4c, 0x45, 0x10, 0x02, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_config_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
...
var file_config_proto_goTypes = []interface{}{
	...
	(Order_Ordering)(0),        // 9: gramophile.Order.Ordering
	(*MoveCriteria)(nil),       // 10: gramophile.MoveCriteria
	(*ValidationCriteria)(nil), // 11: gramophile.ValidationCriteria
	(*ValidationRule)(nil),     // 12: gramophile.ValidationRule
	(*FolderMove)(nil),         // 13: gramophile.FolderMove
	(*MoveQuota)(nil),          // 14: gramophile.MoveQuota
	(*MoveHistory)(nil),        // 15: gramophile.MoveHistory
	(*Filter)(nil),             // 16: gramophile.Filter
	(*Sleeve)(nil),             // 17: gramophile.Sleeve
	(*SleeveConfig)(nil),       // 18: gramophile.SleeveConfig
	(*CleaningConfig)(nil),     // 19: gramophile.CleaningConfig
	(*ListenConfig)(nil),       // 20: gramophile.ListenConfig
	(*Order)(nil),              // 21: gramophile.Order
	(*ListenFilter)(nil),       // 22: gramophile.ListenFilter
	(*GramophileConfig)(nil),   // 23: gramophile.GramophileConfig
	...
	(*WantsConfig)(nil),        // 30: gramophile.WantsConfig
	(proto.SaleStatus)(0),      // 31: discogs.SaleStatus
	(*OrganisationConfig)(nil), // 32: gramophile.OrganisationConfig
}
var file_config_proto_depIdxs = []int32{
	2,  // 0: gramophile.MoveCriteria.has_sale_id:type_name -> gramophile.Bool
	31, // 1: gramophile.MoveCriteria.sale_status:type_name -> discogs.SaleStatus
	...
	11, // 6: gramophile.ValidationRule.validation_criteria:type_name -> gramophile.ValidationCriteria
	4,  // 7: gramophile.ValidationRule.validation_strategy:type_name -> gramophile.ValidationStrategy
	10, // 8: gramophile.FolderMove.criteria:type_name -> gramophile.MoveCriteria
	...
	15, // 11: gramophile.MoveQuota.past_moves:type_name -> gramophile.MoveHistory
	1,  // 12: gramophile.SleeveConfig.mandate:type_name -> gramophile.Mandate
	17, // 13: gramophile.SleeveConfig.allowed_sleeves:type_name -> gramophile.Sleeve
	...
	22, // 17: gramophile.ListenConfig.filters:type_name -> gramophile.ListenFilter
	9,  // 18: gramophile.Order.ordering:type_name -> gramophile.Order.Ordering
	16, // 19: gramophile.ListenFilter.filter:type_name -> gramophile.Filter
	21, // 20: gramophile.ListenFilter.order:type_name -> gramophile.Order
	0,  // 21: gramophile.GramophileConfig.basis:type_name -> gramophile.Basis
	19, // 22: gramophile.GramophileConfig.cleaning_config:type_name -> gramophile.CleaningConfig
	20, // 23: gramophile.GramophileConfig.listen_config:type_name -> gramophile.ListenConfig
	25, // 24: gramophile.GramophileConfig.width_config:type_name -> gramophile.WidthConfig
	32, // 25: gramophile.GramophileConfig.organisation_config:type_name -> gramophile.OrganisationConfig
	...
	18, // 28: gramophile.GramophileConfig.sleeve_config:type_name -> gramophile.SleeveConfig
	...
	30, // 32: gramophile.GramophileConfig.wants_config:type_name -> gramophile.WantsConfig
	...
	13, // 35: gramophile.GramophileConfig.moves:type_name -> gramophile.FolderMove
	12, // 36: gramophile.GramophileConfig.validations:type_name -> gramophile.ValidationRule
	...
	1,  // 44: gramophile.KeepConfig.mandate:type_name -> gramophile.Mandate
	8,  // 45: gramophile.WantsConfig.origin:type_name -> gramophile.WantsBasis
