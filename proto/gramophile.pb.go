...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x22, 0xf2, 0x03, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x2a, 0x0a,
	...
	0x06, 0x73, 0x6c, 0x65, 0x65, 0x76, 0x65, 0x22, 0xaf, 0x01, 0x0a, 0x06, 0x49, 0x6e, 0x74, 0x65,
	...
	0x09, 0x52, 0x06, 0x73, 0x6c, 0x65, 0x65, 0x76, 0x65, 0x22, 0x33, 0x0a, 0x06, 0x51, 0x75, 0x65,
	...
	0x73, 0x22, 0xb9, 0x03, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6c, 0x65, 0x6d, 0x65,
	...
	0x64, 0x61, 0x74, 0x65, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68,
	0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x72, 0x65, 0x66, 0x72, 0x65,
	0x73, 0x68, 0x49, 0x64, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x10, 0x0a,
	...
	0x6e, 0x74, 0x52, 0x08, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x92, 0x03, 0x0a,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x25, 0x0a, 0x12, 0x4e, 0x6f, 0x6e, 0x63, 0x6f, 0x6d, 0x70, 0x6c,
	0x69, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x73, 0x73, 0x75, 0x65, 0x12, 0x0f, 0x0a, 0x0b, 0x4e, 0x45,
	0x45, 0x44, 0x53, 0x5f, 0x43, 0x4c, 0x45, 0x41, 0x4e, 0x10, 0x00, 0x32, 0xd7, 0x01, 0x0a, 0x0c,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0xb1, 0x05, 0x0a, 0x12, 0x47, 0x72, 0x61, 0x6d, 0x6f, 0x70,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*RefreshUpdates)(nil),         // 7: gramophile.RefreshUpdates
	(*RefreshUserEntry)(nil),       // 8: gramophile.RefreshUserEntry
	(*RefreshCollectionEntry)(nil), // 9: gramophile.RefreshCollectionEntry
	(*CleanCollectionEntry)(nil),   // 10: gramophile.CleanCollectionEntry
	(*RefreshIntents)(nil),         // 11: gramophile.RefreshIntents
	(*EnqueueRequest)(nil),         // 12: gramophile.EnqueueRequest
	(*EnqueueResponse)(nil),        // 13: gramophile.EnqueueResponse
	(*ListRequest)(nil),            // 14: gramophile.ListRequest
	(*ListResponse)(nil),           // 15: gramophile.ListResponse
	(*StoredUser)(nil),             // 16: gramophile.StoredUser
	(*GramophileAuth)(nil),         // 17: gramophile.GramophileAuth
	(*UserLoginAttempts)(nil),      // 18: gramophile.UserLoginAttempts
	(*UserLoginAttempt)(nil),       // 19: gramophile.UserLoginAttempt
	(*GetURLRequest)(nil),          // 20: gramophile.GetURLRequest
	(*GetURLResponse)(nil),         // 21: gramophile.GetURLResponse
	(*GetLoginRequest)(nil),        // 22: gramophile.GetLoginRequest
	(*GetLoginResponse)(nil),       // 23: gramophile.GetLoginResponse
	(*GetStateRequest)(nil),        // 24: gramophile.GetStateRequest
	(*GetStateResponse)(nil),       // 25: gramophile.GetStateResponse
	(*SetConfigRequest)(nil),       // 26: gramophile.SetConfigRequest
	(*SetConfigResponse)(nil),      // 27: gramophile.SetConfigResponse
	(*SetIntentRequest)(nil),       // 28: gramophile.SetIntentRequest
	(*SetIntentResponse)(nil),      // 29: gramophile.SetIntentResponse
	(*GetRecordRequest)(nil),       // 30: gramophile.GetRecordRequest
	(*GetRecordWithId)(nil),        // 31: gramophile.GetRecordWithId
	(*GetRecordWithIssue)(nil),     // 32: gramophile.GetRecordWithIssue
	(*GetRecordToListenTo)(nil),    // 33: gramophile.GetRecordToListenTo
	(*GetRecordResponse)(nil),      // 34: gramophile.GetRecordResponse
	(*GetOrgRequest)(nil),          // 35: gramophile.GetOrgRequest
	(*GetOrgResponse)(nil),         // 36: gramophile.GetOrgResponse
	(*SetOrgSnapshotRequest)(nil),  // 37: gramophile.SetOrgSnapshotRequest
	(*SetOrgSnapshotResponse)(nil), // 38: gramophile.SetOrgSnapshotResponse
	(*GetUserRequest)(nil),         // 39: gramophile.GetUserRequest
	(*GetUserResponse)(nil),        // 40: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),        // 41: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),       // 42: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),      // 43: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil),     // 44: gramophile.DeleteUserResponse
	(*CleanRequest)(nil),           // 45: gramophile.CleanRequest
	(*CleanResponse)(nil),          // 46: gramophile.CleanResponse
	(*proto.Release)(nil),          // 47: discogs.Release
	(*proto.User)(nil),             // 48: discogs.User
	(*GramophileConfig)(nil),       // 49: gramophile.GramophileConfig
	(*proto.Folder)(nil),           // 50: discogs.Folder
	(*OrganisationSnapshot)(nil),   // 51: gramophile.OrganisationSnapshot
}
var file_gramophile_proto_depIdxs = []int32{
	...
	47, // 2: gramophile.Record.release:type_name -> discogs.Release
	...
	8,  // 7: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	9,  // 8: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollectionEntry
	11, // 9: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	7,  // 10: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	6,  // 11: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	6,  // 12: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	17, // 13: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	48, // 14: gramophile.StoredUser.user:type_name -> discogs.User
	49, // 15: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	50, // 16: gramophile.StoredUser.folders:type_name -> discogs.Folder
	19, // 17: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	17, // 18: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	49, // 19: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	3,  // 20: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	32, // 21: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	33, // 22: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	31, // 23: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	2,  // 24: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	2,  // 25: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	51, // 26: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	16, // 27: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	16, // 28: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	12, // 29: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	12, // 30: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	14, // 31: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	20, // 32: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	22, // 33: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	39, // 34: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	24, // 35: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	26, // 36: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	28, // 37: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	30, // 38: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	35, // 39: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	37, // 40: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	41, // 41: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	43, // 42: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	45, // 43: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	13, // 44: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	13, // 45: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	15, // 46: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	21, // 47: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	23, // 48: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	40, // 49: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	25, // 50: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	27, // 51: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	29, // 52: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	34, // 53: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	36, // 54: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	38, // 55: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	42, // 56: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	44, // 57: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	46, // 58: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
...
func file_gramophile_proto_init() {
	...
	file_gramophile_proto_msgTypes[29].OneofWrappers = []interface{}{
