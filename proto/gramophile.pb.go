...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6e, 0x74, 0x52, 0x08, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xc7,
	0x0c, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x49, 0x64, 0x42,
	0x07, 0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x35, 0x0a, 0x0d, 0x41, 0x64, 0x64, 0x4d,
	...
	0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x22, 0x7f, 0x0a, 0x0b, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73,
	...
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xb8, 0x02, 0x0a, 0x10, 0x47, 0x65, 0x74,
	...
	0x75, 0x6e, 0x74, 0x22, 0x48, 0x0a, 0x10, 0x53, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x63, 0x6f, 0x72, 0x64, 0x73, 0x22, 0x3e, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x67, 0x52,
	...
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x4e, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x67, 0x52,
	...
	0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x37, 0x0a, 0x14, 0x52,
	...
	0x63, 0x65, 0x49, 0x64, 0x22, 0x17, 0x0a, 0x15, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x52,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 95)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*AddMasterWant)(nil),               // 25: gramophile.AddMasterWant
	(*UpdateMasterWant)(nil),            // 26: gramophile.UpdateMasterWant
	(*RefreshWant)(nil),                 // 27: gramophile.RefreshWant
	(*SyncWants)(nil),                   // 28: gramophile.SyncWants
	(*RefreshEarliestReleaseDates)(nil), // 29: gramophile.RefreshEarliestReleaseDates
	(*RefreshEarliestReleaseDate)(nil),  // 30: gramophile.RefreshEarliestReleaseDate
	(*RefreshCollection)(nil),           // 31: gramophile.RefreshCollection
	(*RefreshRelease)(nil),              // 32: gramophile.RefreshRelease
	(*UpdateSale)(nil),                  // 33: gramophile.UpdateSale
	(*MoveRecord)(nil),                  // 34: gramophile.MoveRecord
	(*MoveRecords)(nil),                 // 35: gramophile.MoveRecords
	(*RefreshWants)(nil),                // 36: gramophile.RefreshWants
	(*AddWant)(nil),                     // 37: gramophile.AddWant
	(*RefreshWantlists)(nil),            // 38: gramophile.RefreshWantlists
	(*LinkSales)(nil),                   // 39: gramophile.LinkSales
	(*RefreshSales)(nil),                // 40: gramophile.RefreshSales
	(*AddFolderUpdate)(nil),             // 41: gramophile.AddFolderUpdate
	(*RefreshUpdates)(nil),              // 42: gramophile.RefreshUpdates
	(*RefreshUserEntry)(nil),            // 43: gramophile.RefreshUserEntry
	(*RefreshCollectionEntry)(nil),      // 44: gramophile.RefreshCollectionEntry
	(*CleanCollectionEntry)(nil),        // 45: gramophile.CleanCollectionEntry
	(*RefreshIntents)(nil),              // 46: gramophile.RefreshIntents
	(*EnqueueRequest)(nil),              // 47: gramophile.EnqueueRequest
	(*EnqueueResponse)(nil),             // 48: gramophile.EnqueueResponse
	(*ListRequest)(nil),                 // 49: gramophile.ListRequest
	(*ListResponse)(nil),                // 50: gramophile.ListResponse
	(*DrainRequest)(nil),                // 51: gramophile.DrainRequest
	(*DrainResponse)(nil),               // 52: gramophile.DrainResponse
	(*StoredUser)(nil),                  // 53: gramophile.StoredUser
	(*GramophileAuth)(nil),              // 54: gramophile.GramophileAuth
	(*UserLoginAttempts)(nil),           // 55: gramophile.UserLoginAttempts
	(*UserLoginAttempt)(nil),            // 56: gramophile.UserLoginAttempt
	(*GetURLRequest)(nil),               // 57: gramophile.GetURLRequest
	(*GetURLResponse)(nil),              // 58: gramophile.GetURLResponse
	(*GetLoginRequest)(nil),             // 59: gramophile.GetLoginRequest
	(*GetLoginResponse)(nil),            // 60: gramophile.GetLoginResponse
	(*GetStateRequest)(nil),             // 61: gramophile.GetStateRequest
	(*GetStateResponse)(nil),            // 62: gramophile.GetStateResponse
	(*SetConfigRequest)(nil),            // 63: gramophile.SetConfigRequest
	(*SetConfigResponse)(nil),           // 64: gramophile.SetConfigResponse
	(*SetIntentRequest)(nil),            // 65: gramophile.SetIntentRequest
	(*SetIntentResponse)(nil),           // 66: gramophile.SetIntentResponse
	(*GetRecordRequest)(nil),            // 67: gramophile.GetRecordRequest
	(*RecordResponse)(nil),              // 68: gramophile.RecordResponse
	(*GetRecordWithId)(nil),             // 69: gramophile.GetRecordWithId
	(*GetRecordWithIssue)(nil),          // 70: gramophile.GetRecordWithIssue
	(*GetRecordToListenTo)(nil),         // 71: gramophile.GetRecordToListenTo
	(*GetRecordResponse)(nil),           // 72: gramophile.GetRecordResponse
	(*GetOrgRequest)(nil),               // 73: gramophile.GetOrgRequest
	(*GetOrgResponse)(nil),              // 74: gramophile.GetOrgResponse
	(*SetOrgSnapshotRequest)(nil),       // 75: gramophile.SetOrgSnapshotRequest
	(*SetOrgSnapshotResponse)(nil),      // 76: gramophile.SetOrgSnapshotResponse
	(*AddWantlistRequest)(nil),          // 77: gramophile.AddWantlistRequest
	(*AddWantlistResponse)(nil),         // 78: gramophile.AddWantlistResponse
	(*RefreshRecordRequest)(nil),        // 79: gramophile.RefreshRecordRequest
	(*RefreshRecordResponse)(nil),       // 80: gramophile.RefreshRecordResponse
	(*GetSaleRequest)(nil),              // 81: gramophile.GetSaleRequest
	(*GetSaleResponse)(nil),             // 82: gramophile.GetSaleResponse
	(*ListWantlistsRequest)(nil),        // 83: gramophile.ListWantlistsRequest
	(*ListWantlistsResponse)(nil),       // 84: gramophile.ListWantlistsResponse
	(*UpdateWantlistRequest)(nil),       // 85: gramophile.UpdateWantlistRequest
	(*UpdateWantlistResponse)(nil),      // 86: gramophile.UpdateWantlistResponse
	(*GetWantsRequest)(nil),             // 87: gramophile.GetWantsRequest
	(*GetWantsResponse)(nil),            // 88: gramophile.GetWantsResponse
	(*WantResponse)(nil),                // 89: gramophile.WantResponse
	(*AddWantRequest)(nil),              // 90: gramophile.AddWantRequest
	(*AddWantResponse)(nil),             // 91: gramophile.AddWantResponse
	(*GetWantlistRequest)(nil),          // 92: gramophile.GetWantlistRequest
	(*GetWantlistResponse)(nil),         // 93: gramophile.GetWantlistResponse
	(*GetUserRequest)(nil),              // 94: gramophile.GetUserRequest
	(*GetUserResponse)(nil),             // 95: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),             // 96: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),            // 97: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),           // 98: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil),          // 99: gramophile.DeleteUserResponse
	(*CleanRequest)(nil),                // 100: gramophile.CleanRequest
	(*CleanResponse)(nil),               // 101: gramophile.CleanResponse
	(*proto.Release)(nil),               // 102: discogs.Release
	(*proto.Price)(nil),                 // 103: discogs.Price
	(proto.SaleStatus)(0),               // 104: discogs.SaleStatus
	(*proto.User)(nil),                  // 105: discogs.User
	(*GramophileConfig)(nil),            // 106: gramophile.GramophileConfig
	(*proto.Folder)(nil),                // 107: discogs.Folder
	(*FolderMove)(nil),                  // 108: gramophile.FolderMove
	(*OrganisationSnapshot)(nil),        // 109: gramophile.OrganisationSnapshot
}
var file_gramophile_proto_depIdxs = []int32{
	...
	102, // 18: gramophile.Record.release:type_name -> discogs.Release
	...
	103, // 21: gramophile.Record.median_price:type_name -> discogs.Price
	103, // 22: gramophile.Record.low_price:type_name -> discogs.Price
	104, // 23: gramophile.SaleInfo.sale_state:type_name -> discogs.SaleStatus
	103, // 24: gramophile.SaleInfo.current_price:type_name -> discogs.Price
	103, // 25: gramophile.SaleInfo.initial_price:type_name -> discogs.Price
	103, // 26: gramophile.SaleInfo.median_price:type_name -> discogs.Price
	103, // 27: gramophile.SaleInfo.low_price:type_name -> discogs.Price
	20,  // 28: gramophile.SaleInfo.updates:type_name -> gramophile.PriceUpdate
	103, // 29: gramophile.PriceUpdate.set_price:type_name -> discogs.Price
	...
	43,  // 33: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	44,  // 34: gramophile.QueueElement.refresh_collection_entry:type_name -> gramophile.RefreshCollectionEntry
	46,  // 35: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	42,  // 36: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	41,  // 37: gramophile.QueueElement.add_folder_update:type_name -> gramophile.AddFolderUpdate
	40,  // 38: gramophile.QueueElement.refresh_sales:type_name -> gramophile.RefreshSales
	39,  // 39: gramophile.QueueElement.link_sales:type_name -> gramophile.LinkSales
	38,  // 40: gramophile.QueueElement.refresh_wantlists:type_name -> gramophile.RefreshWantlists
	36,  // 41: gramophile.QueueElement.refresh_wants:type_name -> gramophile.RefreshWants
	33,  // 42: gramophile.QueueElement.update_sale:type_name -> gramophile.UpdateSale
	35,  // 43: gramophile.QueueElement.move_records:type_name -> gramophile.MoveRecords
	34,  // 44: gramophile.QueueElement.move_record:type_name -> gramophile.MoveRecord
	32,  // 45: gramophile.QueueElement.refresh_release:type_name -> gramophile.RefreshRelease
	31,  // 46: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollection
	29,  // 47: gramophile.QueueElement.refresh_earliest_release_dates:type_name -> gramophile.RefreshEarliestReleaseDates
	30,  // 48: gramophile.QueueElement.refresh_earliest_release_date:type_name -> gramophile.RefreshEarliestReleaseDate
	28,  // 49: gramophile.QueueElement.sync_wants:type_name -> gramophile.SyncWants
	27,  // 50: gramophile.QueueElement.refresh_want:type_name -> gramophile.RefreshWant
	25,  // 51: gramophile.QueueElement.add_master_want:type_name -> gramophile.AddMasterWant
	26,  // 52: gramophile.QueueElement.update_master_want:type_name -> gramophile.UpdateMasterWant
	14,  // 53: gramophile.AddMasterWant.want:type_name -> gramophile.Want
	14,  // 54: gramophile.UpdateMasterWant.want:type_name -> gramophile.Want
	2,   // 55: gramophile.UpdateMasterWant.new_state:type_name -> gramophile.WantState
	14,  // 56: gramophile.RefreshWant.want:type_name -> gramophile.Want
	2,   // 57: gramophile.RefreshWant.new_state:type_name -> gramophile.WantState
	13,  // 58: gramophile.AddWant.filter:type_name -> gramophile.WantFilter
	24,  // 59: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	24,  // 60: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	54,  // 61: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	105, // 62: gramophile.StoredUser.user:type_name -> discogs.User
	106, // 63: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	107, // 64: gramophile.StoredUser.folders:type_name -> discogs.Folder
	108, // 65: gramophile.StoredUser.moves:type_name -> gramophile.FolderMove
	56,  // 66: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	54,  // 67: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	106, // 68: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	21,  // 69: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	70,  // 70: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	71,  // 71: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	69,  // 72: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	18,  // 73: gramophile.RecordResponse.record:type_name -> gramophile.Record
	15,  // 74: gramophile.RecordResponse.updates:type_name -> gramophile.RecordUpdate
	19,  // 75: gramophile.RecordResponse.sale_info:type_name -> gramophile.SaleInfo
	68,  // 76: gramophile.GetRecordResponse.records:type_name -> gramophile.RecordResponse
	109, // 77: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	0,   // 78: gramophile.AddWantlistRequest.type:type_name -> gramophile.WantlistType
	1,   // 79: gramophile.AddWantlistRequest.visibility:type_name -> gramophile.WantlistVisibility
	19,  // 80: gramophile.GetSaleResponse.sales:type_name -> gramophile.SaleInfo
	11,  // 81: gramophile.ListWantlistsResponse.lists:type_name -> gramophile.Wantlist
	0,   // 82: gramophile.UpdateWantlistRequest.new_type:type_name -> gramophile.WantlistType
	89,  // 83: gramophile.GetWantsResponse.wants:type_name -> gramophile.WantResponse
	14,  // 84: gramophile.WantResponse.want:type_name -> gramophile.Want
	16,  // 85: gramophile.WantResponse.updates:type_name -> gramophile.Update
	13,  // 86: gramophile.AddWantRequest.filter:type_name -> gramophile.WantFilter
	11,  // 87: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	53,  // 88: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	53,  // 89: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	47,  // 90: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	47,  // 91: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	49,  // 92: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	51,  // 93: gramophile.QueueService.Drain:input_type -> gramophile.DrainRequest
	57,  // 94: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	59,  // 95: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	94,  // 96: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	61,  // 97: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	63,  // 98: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	65,  // 99: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	67,  // 100: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	79,  // 101: gramophile.GramophileEService.RefreshRecord:input_type -> gramophile.RefreshRecordRequest
	73,  // 102: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	75,  // 103: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	90,  // 104: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	87,  // 105: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	77,  // 106: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	92,  // 107: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	85,  // 108: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	83,  // 109: gramophile.GramophileEService.ListWantlists:input_type -> gramophile.ListWantlistsRequest
	81,  // 110: gramophile.GramophileEService.GetSale:input_type -> gramophile.GetSaleRequest
	96,  // 111: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	98,  // 112: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	100, // 113: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	48,  // 114: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	48,  // 115: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	50,  // 116: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	52,  // 117: gramophile.QueueService.Drain:output_type -> gramophile.DrainResponse
	58,  // 118: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	60,  // 119: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	95,  // 120: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	62,  // 121: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	64,  // 122: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	66,  // 123: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	72,  // 124: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	80,  // 125: gramophile.GramophileEService.RefreshRecord:output_type -> gramophile.RefreshRecordResponse
	74,  // 126: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	76,  // 127: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	91,  // 128: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	88,  // 129: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	78,  // 130: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	93,  // 131: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	86,  // 132: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	84,  // 133: gramophile.GramophileEService.ListWantlists:output_type -> gramophile.ListWantlistsResponse
	82,  // 134: gramophile.GramophileEService.GetSale:output_type -> gramophile.GetSaleResponse
	97,  // 135: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	99,  // 136: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	101, // 137: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
...
func file_gramophile_proto_init() {
	...
	file_gramophile_proto_msgTypes[60].OneofWrappers = []interface{}{
