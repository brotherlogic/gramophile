...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0x54, 0x0a,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0x13, 0x0a, 0x11,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*proto.User)(nil),        // 16: discogs.User
}
var file_gramophile_proto_depIdxs = []int32{
	...
	16, // 5: gramophile.StoredUser.user:type_name -> discogs.User
	...
	4,  // 13: gramophile.QueueService.Execute:output_type -> gramophile.ExecuteResponse
	11, // 14: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	13, // 15: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	15, // 16: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
