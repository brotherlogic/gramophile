...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xb9, 0x03, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45,
	...
	0x73, 0x68, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x66,
	...
	0x79, 0x22, 0x10, 0x0a, 0x0e, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x55, 0x70, 0x64, 0x61,
	...
	0x22, 0x92, 0x03, 0x0a, 0x0a, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x6c, 0x64, 0x65, 0x72, 0x73, 0x22, 0x26, 0x0a, 0x0e, 0x47, 0x72, 0x61, 0x6d, 0x6f, 0x70, 0x68,
	...
	0x44, 0x41, 0x54, 0x45, 0x5f, 0x42, 0x4f, 0x55, 0x4e, 0x44, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x33,
	0x0a, 0x09, 0x57, 0x61, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0a, 0x0a, 0x06, 0x57,
	0x41, 0x4e, 0x54, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x45, 0x54, 0x49, 0x52,
	0x45, 0x44, 0x10, 0x01, 0x12, 0x0d, 0x0a, 0x09, 0x50, 0x55, 0x52, 0x43, 0x48, 0x41, 0x53, 0x45,
	0x44, 0x10, 0x02, 0x2a, 0x25, 0x0a, 0x12, 0x4e, 0x6f, 0x6e, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x69,
...
var file_gramophile_proto_depIdxs = []int32{
	...
	15, // 14: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	16, // 15: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollectionEntry
	18, // 16: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	14, // 17: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	13, // 18: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	13, // 19: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	24, // 20: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	68, // 21: gramophile.StoredUser.user:type_name -> discogs.User
	69, // 22: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	70, // 23: gramophile.StoredUser.folders:type_name -> discogs.Folder
	26, // 24: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	24, // 25: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	69, // 26: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	10, // 27: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	39, // 28: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	40, // 29: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	38, // 30: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	8,  // 31: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	8,  // 32: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	71, // 33: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	0,  // 34: gramophile.AddWantlistRequest.type:type_name -> gramophile.WantlistType
	6,  // 35: gramophile.GetWantsResponse.wants:type_name -> gramophile.Want
	4,  // 36: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	23, // 37: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	23, // 38: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	19, // 39: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	19, // 40: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	21, // 41: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	27, // 42: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	29, // 43: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	58, // 44: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	31, // 45: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	33, // 46: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	35, // 47: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	37, // 48: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	42, // 49: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	44, // 50: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	54, // 51: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	50, // 52: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	52, // 53: gramophile.GramophileEService.DeleteWant:input_type -> gramophile.DeleteWantRequest
	46, // 54: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	56, // 55: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	48, // 56: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	60, // 57: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	62, // 58: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	64, // 59: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	20, // 60: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	20, // 61: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	22, // 62: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	28, // 63: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	30, // 64: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	59, // 65: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	32, // 66: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	34, // 67: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	36, // 68: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	41, // 69: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	43, // 70: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	45, // 71: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	55, // 72: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	51, // 73: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	53, // 74: gramophile.GramophileEService.DeleteWant:output_type -> gramophile.DeleteWantResponse
	47, // 75: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	57, // 76: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	49, // 77: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	61, // 78: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	63, // 79: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	65, // 80: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
