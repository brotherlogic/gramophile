...
type QueueElement_MoveRecord struct {
	MoveRecord *MoveRecord `protobuf:"bytes,16,opt,name=move_record,json=moveRecord,proto3,oneof"`
}
...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xb6, 0x07, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45,
	...
	0x6f, 0x76, 0x65, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b,
	...
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73,
	0x68, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x72, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x49, 0x64, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x4b,
	...
	0x0a, 0x6d, 0x6f, 0x76, 0x65, 0x46, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x22, 0x0d, 0x0a, 0x0b, 0x4d,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 70)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*MoveRecord)(nil),             // 14: gramophile.MoveRecord
	(*MoveRecords)(nil),            // 15: gramophile.MoveRecords
	(*RefreshWants)(nil),           // 16: gramophile.RefreshWants
	(*AddWant)(nil),                // 17: gramophile.AddWant
	(*RefreshWantlists)(nil),       // 18: gramophile.RefreshWantlists
	(*LinkSales)(nil),              // 19: gramophile.LinkSales
	(*RefreshSales)(nil),           // 20: gramophile.RefreshSales
	(*AddFolderUpdate)(nil),        // 21: gramophile.AddFolderUpdate
	(*RefreshUpdates)(nil),         // 22: gramophile.RefreshUpdates
	(*RefreshUserEntry)(nil),       // 23: gramophile.RefreshUserEntry
	(*RefreshCollectionEntry)(nil), // 24: gramophile.RefreshCollectionEntry
	(*CleanCollectionEntry)(nil),   // 25: gramophile.CleanCollectionEntry
	(*RefreshIntents)(nil),         // 26: gramophile.RefreshIntents
	(*EnqueueRequest)(nil),         // 27: gramophile.EnqueueRequest
	(*EnqueueResponse)(nil),        // 28: gramophile.EnqueueResponse
	(*ListRequest)(nil),            // 29: gramophile.ListRequest
	(*ListResponse)(nil),           // 30: gramophile.ListResponse
	(*StoredUser)(nil),             // 31: gramophile.StoredUser
	(*GramophileAuth)(nil),         // 32: gramophile.GramophileAuth
	(*UserLoginAttempts)(nil),      // 33: gramophile.UserLoginAttempts
	(*UserLoginAttempt)(nil),       // 34: gramophile.UserLoginAttempt
	(*GetURLRequest)(nil),          // 35: gramophile.GetURLRequest
	(*GetURLResponse)(nil),         // 36: gramophile.GetURLResponse
	(*GetLoginRequest)(nil),        // 37: gramophile.GetLoginRequest
	(*GetLoginResponse)(nil),       // 38: gramophile.GetLoginResponse
	(*GetStateRequest)(nil),        // 39: gramophile.GetStateRequest
	(*GetStateResponse)(nil),       // 40: gramophile.GetStateResponse
	(*SetConfigRequest)(nil),       // 41: gramophile.SetConfigRequest
	(*SetConfigResponse)(nil),      // 42: gramophile.SetConfigResponse
	(*SetIntentRequest)(nil),       // 43: gramophile.SetIntentRequest
	(*SetIntentResponse)(nil),      // 44: gramophile.SetIntentResponse
	(*GetRecordRequest)(nil),       // 45: gramophile.GetRecordRequest
	(*GetRecordWithId)(nil),        // 46: gramophile.GetRecordWithId
	(*GetRecordWithIssue)(nil),     // 47: gramophile.GetRecordWithIssue
	(*GetRecordToListenTo)(nil),    // 48: gramophile.GetRecordToListenTo
	(*GetRecordResponse)(nil),      // 49: gramophile.GetRecordResponse
	(*GetOrgRequest)(nil),          // 50: gramophile.GetOrgRequest
	(*GetOrgResponse)(nil),         // 51: gramophile.GetOrgResponse
	(*SetOrgSnapshotRequest)(nil),  // 52: gramophile.SetOrgSnapshotRequest
	(*SetOrgSnapshotResponse)(nil), // 53: gramophile.SetOrgSnapshotResponse
	(*AddWantlistRequest)(nil),     // 54: gramophile.AddWantlistRequest
	(*AddWantlistResponse)(nil),    // 55: gramophile.AddWantlistResponse
	(*UpdateWantlistRequest)(nil),  // 56: gramophile.UpdateWantlistRequest
	(*UpdateWantlistResponse)(nil), // 57: gramophile.UpdateWantlistResponse
	(*GetWantsRequest)(nil),        // 58: gramophile.GetWantsRequest
	(*GetWantsResponse)(nil),       // 59: gramophile.GetWantsResponse
	(*DeleteWantRequest)(nil),      // 60: gramophile.DeleteWantRequest
	(*DeleteWantResponse)(nil),     // 61: gramophile.DeleteWantResponse
	(*AddWantRequest)(nil),         // 62: gramophile.AddWantRequest
	(*AddWantResponse)(nil),        // 63: gramophile.AddWantResponse
	(*GetWantlistRequest)(nil),     // 64: gramophile.GetWantlistRequest
	(*GetWantlistResponse)(nil),    // 65: gramophile.GetWantlistResponse
	(*GetUserRequest)(nil),         // 66: gramophile.GetUserRequest
	(*GetUserResponse)(nil),        // 67: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),        // 68: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),       // 69: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),      // 70: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil),     // 71: gramophile.DeleteUserResponse
	(*CleanRequest)(nil),           // 72: gramophile.CleanRequest
	(*CleanResponse)(nil),          // 73: gramophile.CleanResponse
	(*proto.Release)(nil),          // 74: discogs.Release
	(proto.SaleStatus)(0),          // 75: discogs.SaleStatus
	(*proto.Price)(nil),            // 76: discogs.Price
	(*proto.User)(nil),             // 77: discogs.User
	(*GramophileConfig)(nil),       // 78: gramophile.GramophileConfig
	(*proto.Folder)(nil),           // 79: discogs.Folder
	(*FolderMove)(nil),             // 80: gramophile.FolderMove
	(*OrganisationSnapshot)(nil),   // 81: gramophile.OrganisationSnapshot
}
var file_gramophile_proto_depIdxs = []int32{
	...
	74, // 6: gramophile.Record.release:type_name -> discogs.Release
	...
	75, // 11: gramophile.SaleInfo.sale_state:type_name -> discogs.SaleStatus
	76, // 12: gramophile.SaleInfo.currentPrice:type_name -> discogs.Price
	...
	23, // 16: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	24, // 17: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollectionEntry
	26, // 18: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	22, // 19: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	21, // 20: gramophile.QueueElement.add_folder_update:type_name -> gramophile.AddFolderUpdate
	20, // 21: gramophile.QueueElement.refresh_sales:type_name -> gramophile.RefreshSales
	19, // 22: gramophile.QueueElement.link_sales:type_name -> gramophile.LinkSales
	18, // 23: gramophile.QueueElement.refresh_wantlists:type_name -> gramophile.RefreshWantlists
	17, // 24: gramophile.QueueElement.add_want:type_name -> gramophile.AddWant
	16, // 25: gramophile.QueueElement.refresh_wants:type_name -> gramophile.RefreshWants
	15, // 26: gramophile.QueueElement.move_records:type_name -> gramophile.MoveRecords
	14, // 27: gramophile.QueueElement.move_record:type_name -> gramophile.MoveRecord
	13, // 28: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	13, // 29: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	32, // 30: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	77, // 31: gramophile.StoredUser.user:type_name -> discogs.User
	78, // 32: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	79, // 33: gramophile.StoredUser.folders:type_name -> discogs.Folder
	80, // 34: gramophile.StoredUser.moves:type_name -> gramophile.FolderMove
	34, // 35: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	32, // 36: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	78, // 37: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	10, // 38: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	47, // 39: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	48, // 40: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	46, // 41: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	8,  // 42: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	8,  // 43: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	81, // 44: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	0,  // 45: gramophile.AddWantlistRequest.type:type_name -> gramophile.WantlistType
	6,  // 46: gramophile.GetWantsResponse.wants:type_name -> gramophile.Want
	4,  // 47: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	31, // 48: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	31, // 49: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	27, // 50: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	27, // 51: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	29, // 52: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	35, // 53: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	37, // 54: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	66, // 55: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	39, // 56: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	41, // 57: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	43, // 58: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	45, // 59: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	50, // 60: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	52, // 61: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	62, // 62: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	58, // 63: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	60, // 64: gramophile.GramophileEService.DeleteWant:input_type -> gramophile.DeleteWantRequest
	54, // 65: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	64, // 66: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	56, // 67: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	68, // 68: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	70, // 69: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	72, // 70: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	28, // 71: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	28, // 72: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	30, // 73: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	36, // 74: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	38, // 75: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	67, // 76: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	40, // 77: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	42, // 78: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	44, // 79: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	49, // 80: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	51, // 81: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	53, // 82: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	63, // 83: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	59, // 84: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	61, // 85: gramophile.GramophileEService.DeleteWant:output_type -> gramophile.DeleteWantResponse
	55, // 86: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	65, // 87: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	57, // 88: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	69, // 89: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	71, // 90: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	73, // 91: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
...
func file_gramophile_proto_init() {
	...
	file_gramophile_proto_msgTypes[41].OneofWrappers = []interface{}{
