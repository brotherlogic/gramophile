...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x22, 0x42, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x57, 0x61, 0x6e, 0x74, 0x73, 0x52, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x3e, 0x0a, 0x0c, 0x57, 0x61, 0x6e, 0x74, 0x6c, 0x69, 0x73,
	0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0c, 0x0a, 0x08, 0x45, 0x4e, 0x5f, 0x4d, 0x41, 0x53, 0x53,
	0x45, 0x10, 0x00, 0x12, 0x0e, 0x0a, 0x0a, 0x4f, 0x4e, 0x45, 0x5f, 0x42, 0x59, 0x5f, 0x4f, 0x4e,
	0x45, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x44, 0x41, 0x54, 0x45, 0x5f, 0x42, 0x4f, 0x55, 0x4e,
	0x44, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x30, 0x0a, 0x12, 0x57, 0x61, 0x6e, 0x74, 0x6c, 0x69, 0x73,
	...
	0x53, 0x49, 0x42, 0x4c, 0x45, 0x10, 0x01, 0x2a, 0x59, 0x0a, 0x09, 0x57, 0x61, 0x6e, 0x74, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x50, 0x45, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x10,
	0x00, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x45, 0x54, 0x49, 0x52, 0x45, 0x44, 0x10, 0x01, 0x12, 0x0d,
	0x0a, 0x09, 0x50, 0x55, 0x52, 0x43, 0x48, 0x41, 0x53, 0x45, 0x44, 0x10, 0x02, 0x12, 0x0a, 0x0a,
	0x06, 0x57, 0x41, 0x4e, 0x54, 0x45, 0x44, 0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x48, 0x49, 0x44,
	0x44, 0x45, 0x4e, 0x10, 0x04, 0x12, 0x0b, 0x0a, 0x07, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x44,
	0x10, 0x05, 0x2a, 0x25, 0x0a, 0x12, 0x4e, 0x6f, 0x6e, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x69, 0x61,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0xef, 0x09, 0x0a, 0x12, 0x47, 0x72,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 86)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*WantResponse)(nil),                // 79: gramophile.WantResponse
	(*AddWantRequest)(nil),              // 80: gramophile.AddWantRequest
	(*AddWantResponse)(nil),             // 81: gramophile.AddWantResponse
	(*GetWantlistRequest)(nil),          // 82: gramophile.GetWantlistRequest
	(*GetWantlistResponse)(nil),         // 83: gramophile.GetWantlistResponse
	(*GetUserRequest)(nil),              // 84: gramophile.GetUserRequest
	(*GetUserResponse)(nil),             // 85: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),             // 86: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),            // 87: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),           // 88: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil),          // 89: gramophile.DeleteUserResponse
	(*CleanRequest)(nil),                // 90: gramophile.CleanRequest
	(*CleanResponse)(nil),               // 91: gramophile.CleanResponse
	(*proto.Release)(nil),               // 92: discogs.Release
	(*proto.Price)(nil),                 // 93: discogs.Price
	(proto.SaleStatus)(0),               // 94: discogs.SaleStatus
	(*proto.User)(nil),                  // 95: discogs.User
	(*GramophileConfig)(nil),            // 96: gramophile.GramophileConfig
	(*proto.Folder)(nil),                // 97: discogs.Folder
	(*FolderMove)(nil),                  // 98: gramophile.FolderMove
	(*OrganisationSnapshot)(nil),        // 99: gramophile.OrganisationSnapshot
}
var file_gramophile_proto_depIdxs = []int32{
	...
	92, // 9: gramophile.Record.release:type_name -> discogs.Release
	...
	93, // 12: gramophile.Record.median_price:type_name -> discogs.Price
	93, // 13: gramophile.Record.low_price:type_name -> discogs.Price
	94, // 14: gramophile.SaleInfo.sale_state:type_name -> discogs.SaleStatus
	93, // 15: gramophile.SaleInfo.current_price:type_name -> discogs.Price
	93, // 16: gramophile.SaleInfo.initial_price:type_name -> discogs.Price
	93, // 17: gramophile.SaleInfo.median_price:type_name -> discogs.Price
	93, // 18: gramophile.SaleInfo.low_price:type_name -> discogs.Price
	14, // 19: gramophile.SaleInfo.updates:type_name -> gramophile.PriceUpdate
	93, // 20: gramophile.PriceUpdate.set_price:type_name -> discogs.Price
	...
	95, // 46: gramophile.StoredUser.user:type_name -> discogs.User
	96, // 47: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	97, // 48: gramophile.StoredUser.folders:type_name -> discogs.Folder
	98, // 49: gramophile.StoredUser.moves:type_name -> gramophile.FolderMove
	...
	96, // 52: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	...
	99, // 61: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	...
	79, // 65: gramophile.GetWantsResponse.wants:type_name -> gramophile.WantResponse
	8,  // 66: gramophile.WantResponse.want:type_name -> gramophile.Want
	10, // 67: gramophile.WantResponse.updates:type_name -> gramophile.Update
	6,  // 68: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	45, // 69: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	45, // 70: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	39, // 71: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	39, // 72: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	41, // 73: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	43, // 74: gramophile.QueueService.Drain:input_type -> gramophile.DrainRequest
	49, // 75: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	51, // 76: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	84, // 77: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	53, // 78: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	55, // 79: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	57, // 80: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	59, // 81: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	71, // 82: gramophile.GramophileEService.RefreshRecord:input_type -> gramophile.RefreshRecordRequest
	65, // 83: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	67, // 84: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	80, // 85: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	77, // 86: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	69, // 87: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	82, // 88: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	75, // 89: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	73, // 90: gramophile.GramophileEService.ListWantlists:input_type -> gramophile.ListWantlistsRequest
	86, // 91: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	88, // 92: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	90, // 93: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	40, // 94: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	40, // 95: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	42, // 96: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	44, // 97: gramophile.QueueService.Drain:output_type -> gramophile.DrainResponse
	50, // 98: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	52, // 99: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	85, // 100: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	54, // 101: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	56, // 102: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	58, // 103: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	64, // 104: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	72, // 105: gramophile.GramophileEService.RefreshRecord:output_type -> gramophile.RefreshRecordResponse
	66, // 106: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	68, // 107: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	81, // 108: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	78, // 109: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	70, // 110: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	83, // 111: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	76, // 112: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	74, // 113: gramophile.GramophileEService.ListWantlists:output_type -> gramophile.ListWantlistsResponse
	87, // 114: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	89, // 115: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	91, // 116: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
