...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x22, 0xbd, 0x06, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6c, 0x65, 0x6d,
	...
	0x66, 0x72, 0x65, 0x73, 0x68, 0x57, 0x61, 0x6e, 0x74, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65,
	...
	0x72, 0x79, 0x22, 0x0e, 0x0a, 0x0c, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x57, 0x61, 0x6e,
	...
	0x6e, 0x74, 0x73, 0x22, 0xec, 0x03, 0x0a, 0x0a, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x55, 0x73,
	...
	0x45, 0x5f, 0x42, 0x4f, 0x55, 0x4e, 0x44, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x40, 0x0a, 0x09, 0x57,
	...
	0x02, 0x12, 0x0a, 0x0a, 0x06, 0x57, 0x41, 0x4e, 0x54, 0x45, 0x44, 0x10, 0x03, 0x2a, 0x25, 0x0a,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 68)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*RefreshWants)(nil),           // 14: gramophile.RefreshWants
	(*AddWant)(nil),                // 15: gramophile.AddWant
	(*RefreshWantlists)(nil),       // 16: gramophile.RefreshWantlists
	(*LinkSales)(nil),              // 17: gramophile.LinkSales
	(*RefreshSales)(nil),           // 18: gramophile.RefreshSales
	(*AddFolderUpdate)(nil),        // 19: gramophile.AddFolderUpdate
	(*RefreshUpdates)(nil),         // 20: gramophile.RefreshUpdates
	(*RefreshUserEntry)(nil),       // 21: gramophile.RefreshUserEntry
	(*RefreshCollectionEntry)(nil), // 22: gramophile.RefreshCollectionEntry
	(*CleanCollectionEntry)(nil),   // 23: gramophile.CleanCollectionEntry
	(*RefreshIntents)(nil),         // 24: gramophile.RefreshIntents
	(*EnqueueRequest)(nil),         // 25: gramophile.EnqueueRequest
	(*EnqueueResponse)(nil),        // 26: gramophile.EnqueueResponse
	(*ListRequest)(nil),            // 27: gramophile.ListRequest
	(*ListResponse)(nil),           // 28: gramophile.ListResponse
	(*StoredUser)(nil),             // 29: gramophile.StoredUser
	(*GramophileAuth)(nil),         // 30: gramophile.GramophileAuth
	(*UserLoginAttempts)(nil),      // 31: gramophile.UserLoginAttempts
	(*UserLoginAttempt)(nil),       // 32: gramophile.UserLoginAttempt
	(*GetURLRequest)(nil),          // 33: gramophile.GetURLRequest
	(*GetURLResponse)(nil),         // 34: gramophile.GetURLResponse
	(*GetLoginRequest)(nil),        // 35: gramophile.GetLoginRequest
	(*GetLoginResponse)(nil),       // 36: gramophile.GetLoginResponse
	(*GetStateRequest)(nil),        // 37: gramophile.GetStateRequest
	(*GetStateResponse)(nil),       // 38: gramophile.GetStateResponse
	(*SetConfigRequest)(nil),       // 39: gramophile.SetConfigRequest
	(*SetConfigResponse)(nil),      // 40: gramophile.SetConfigResponse
	(*SetIntentRequest)(nil),       // 41: gramophile.SetIntentRequest
	(*SetIntentResponse)(nil),      // 42: gramophile.SetIntentResponse
	(*GetRecordRequest)(nil),       // 43: gramophile.GetRecordRequest
	(*GetRecordWithId)(nil),        // 44: gramophile.GetRecordWithId
	(*GetRecordWithIssue)(nil),     // 45: gramophile.GetRecordWithIssue
	(*GetRecordToListenTo)(nil),    // 46: gramophile.GetRecordToListenTo
	(*GetRecordResponse)(nil),      // 47: gramophile.GetRecordResponse
	(*GetOrgRequest)(nil),          // 48: gramophile.GetOrgRequest
	(*GetOrgResponse)(nil),         // 49: gramophile.GetOrgResponse
	(*SetOrgSnapshotRequest)(nil),  // 50: gramophile.SetOrgSnapshotRequest
	(*SetOrgSnapshotResponse)(nil), // 51: gramophile.SetOrgSnapshotResponse
	(*AddWantlistRequest)(nil),     // 52: gramophile.AddWantlistRequest
	(*AddWantlistResponse)(nil),    // 53: gramophile.AddWantlistResponse
	(*UpdateWantlistRequest)(nil),  // 54: gramophile.UpdateWantlistRequest
	(*UpdateWantlistResponse)(nil), // 55: gramophile.UpdateWantlistResponse
	(*GetWantsRequest)(nil),        // 56: gramophile.GetWantsRequest
	(*GetWantsResponse)(nil),       // 57: gramophile.GetWantsResponse
	(*DeleteWantRequest)(nil),      // 58: gramophile.DeleteWantRequest
	(*DeleteWantResponse)(nil),     // 59: gramophile.DeleteWantResponse
	(*AddWantRequest)(nil),         // 60: gramophile.AddWantRequest
	(*AddWantResponse)(nil),        // 61: gramophile.AddWantResponse
	(*GetWantlistRequest)(nil),     // 62: gramophile.GetWantlistRequest
	(*GetWantlistResponse)(nil),    // 63: gramophile.GetWantlistResponse
	(*GetUserRequest)(nil),         // 64: gramophile.GetUserRequest
	(*GetUserResponse)(nil),        // 65: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),        // 66: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),       // 67: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),      // 68: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil),     // 69: gramophile.DeleteUserResponse
	(*CleanRequest)(nil),           // 70: gramophile.CleanRequest
	(*CleanResponse)(nil),          // 71: gramophile.CleanResponse
	(*proto.Release)(nil),          // 72: discogs.Release
	(proto.SaleStatus)(0),          // 73: discogs.SaleStatus
	(*proto.Price)(nil),            // 74: discogs.Price
	(*proto.User)(nil),             // 75: discogs.User
	(*GramophileConfig)(nil),       // 76: gramophile.GramophileConfig
	(*proto.Folder)(nil),           // 77: discogs.Folder
	(*FolderMove)(nil),             // 78: gramophile.FolderMove
	(*OrganisationSnapshot)(nil),   // 79: gramophile.OrganisationSnapshot
}
var file_gramophile_proto_depIdxs = []int32{
	...
	72, // 6: gramophile.Record.release:type_name -> discogs.Release
	...
	73, // 11: gramophile.SaleInfo.sale_state:type_name -> discogs.SaleStatus
	74, // 12: gramophile.SaleInfo.currentPrice:type_name -> discogs.Price
	...
	21, // 16: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	22, // 17: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollectionEntry
	24, // 18: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	20, // 19: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	19, // 20: gramophile.QueueElement.add_folder_update:type_name -> gramophile.AddFolderUpdate
	18, // 21: gramophile.QueueElement.refresh_sales:type_name -> gramophile.RefreshSales
	17, // 22: gramophile.QueueElement.link_sales:type_name -> gramophile.LinkSales
	16, // 23: gramophile.QueueElement.refresh_wantlists:type_name -> gramophile.RefreshWantlists
	15, // 24: gramophile.QueueElement.add_want:type_name -> gramophile.AddWant
	14, // 25: gramophile.QueueElement.refresh_wants:type_name -> gramophile.RefreshWants
	13, // 26: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	13, // 27: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	30, // 28: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	75, // 29: gramophile.StoredUser.user:type_name -> discogs.User
	76, // 30: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	77, // 31: gramophile.StoredUser.folders:type_name -> discogs.Folder
	78, // 32: gramophile.StoredUser.moves:type_name -> gramophile.FolderMove
	32, // 33: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	30, // 34: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	76, // 35: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	10, // 36: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	45, // 37: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	46, // 38: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	44, // 39: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	8,  // 40: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	8,  // 41: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	79, // 42: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	0,  // 43: gramophile.AddWantlistRequest.type:type_name -> gramophile.WantlistType
	6,  // 44: gramophile.GetWantsResponse.wants:type_name -> gramophile.Want
	4,  // 45: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	29, // 46: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	29, // 47: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	25, // 48: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	25, // 49: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	27, // 50: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	33, // 51: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	35, // 52: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	64, // 53: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	37, // 54: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	39, // 55: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	41, // 56: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	43, // 57: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	48, // 58: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	50, // 59: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	60, // 60: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	56, // 61: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	58, // 62: gramophile.GramophileEService.DeleteWant:input_type -> gramophile.DeleteWantRequest
	52, // 63: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	62, // 64: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	54, // 65: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	66, // 66: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	68, // 67: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	70, // 68: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	26, // 69: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	26, // 70: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	28, // 71: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	34, // 72: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	36, // 73: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	65, // 74: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	38, // 75: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	40, // 76: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	42, // 77: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	47, // 78: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	49, // 79: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	51, // 80: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	61, // 81: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	57, // 82: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	59, // 83: gramophile.GramophileEService.DeleteWant:output_type -> gramophile.DeleteWantResponse
	53, // 84: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	63, // 85: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	55, // 86: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	67, // 87: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	69, // 88: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	71, // 89: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
...
func file_gramophile_proto_init() {
	...
	file_gramophile_proto_msgTypes[39].OneofWrappers = []interface{}{
