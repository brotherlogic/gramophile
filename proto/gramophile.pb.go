...
type QueueElement_RefreshUser struct {
	RefreshUser *RefreshUserEntry `protobuf:"bytes,2,opt,name=refresh_user,json=refreshUser,proto3,oneof"`
}
...
type RefreshUserEntry struct {
	...
	User   *StoredUser `protobuf:"bytes,2,opt,name=user,proto3" json:"user,omitempty"`
}
...
func (x *RefreshUserEntry) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *RefreshUserEntry) GetUser() *StoredUser {
	if x != nil {
		return x.User
	}
	return nil
...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x08, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x75, 0x0a, 0x0c, 0x51,
	...
	0x75, 0x6e, 0x44, 0x61, 0x74, 0x65, 0x12, 0x41, 0x0a, 0x0c, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73,
	0x68, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67,
	...
	0x66, 0x72, 0x65, 0x73, 0x68, 0x55, 0x73, 0x65, 0x72, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x6e, 0x74,
	0x72, 0x79, 0x22, 0x57, 0x0a, 0x10, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x55, 0x73, 0x65,
	0x72, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69,
	...
	0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x9f, 0x01, 0x0a, 0x0a,
	...
	0x09, 0x52, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x22, 0x26, 0x0a,
	...
	0x65, 0x41, 0x75, 0x74, 0x68, 0x52, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x10, 0x0a, 0x0e, 0x47,
	...
	0x65, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0xa0, 0x01, 0x0a,
	...
	0x59, 0x0a, 0x11, 0x47, 0x72, 0x61, 0x6d, 0x6f, 0x70, 0x68, 0x69, 0x6c, 0x65, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x44, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12,
...
var file_gramophile_proto_depIdxs = []int32{
	...
	4,  // 3: gramophile.RefreshUserEntry.user:type_name -> gramophile.StoredUser
	5,  // 4: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	14, // 5: gramophile.StoredUser.user:type_name -> discogs.User
	7,  // 6: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	5,  // 7: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	4,  // 8: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	8,  // 9: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	10, // 10: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	12, // 11: gramophile.GramophileService.GetUser:input_type -> gramophile.GetUserRequest
	9,  // 12: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	11, // 13: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	13, // 14: gramophile.GramophileService.GetUser:output_type -> gramophile.GetUserResponse
