...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x0a, 0x6b, 0x65, 0x65, 0x70, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xc1, 0x01,
	...
	0x64, 0x22, 0xf5, 0x01, 0x0a, 0x06, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x73, 0x22, 0xbd, 0x06, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6c, 0x65, 0x6d, 0x65,
	...
	0x72, 0x65, 0x73, 0x68, 0x57, 0x61, 0x6e, 0x74, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x66,
	...
	0x79, 0x22, 0x0e, 0x0a, 0x0c, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x57, 0x61, 0x6e, 0x74,
...
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*proto.User)(nil),             // 74: discogs.User
	(*GramophileConfig)(nil),       // 75: gramophile.GramophileConfig
	(*proto.Folder)(nil),           // 76: discogs.Folder
	(*FolderMove)(nil),             // 77: gramophile.FolderMove
	(*OrganisationSnapshot)(nil),   // 78: gramophile.OrganisationSnapshot
}
var file_gramophile_proto_depIdxs = []int32{
	...
	3,  // 12: gramophile.Intent.keep:type_name -> gramophile.KeepStatus
	12, // 13: gramophile.Queues.queues:type_name -> gramophile.Queue
	13, // 14: gramophile.Queue.elements:type_name -> gramophile.QueueElement
	21, // 15: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	22, // 16: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollectionEntry
	24, // 17: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	20, // 18: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	19, // 19: gramophile.QueueElement.add_folder_update:type_name -> gramophile.AddFolderUpdate
	18, // 20: gramophile.QueueElement.refresh_sales:type_name -> gramophile.RefreshSales
	17, // 21: gramophile.QueueElement.link_sales:type_name -> gramophile.LinkSales
	16, // 22: gramophile.QueueElement.refresh_wantlists:type_name -> gramophile.RefreshWantlists
	15, // 23: gramophile.QueueElement.add_want:type_name -> gramophile.AddWant
	14, // 24: gramophile.QueueElement.refresh_wants:type_name -> gramophile.RefreshWants
	13, // 25: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	13, // 26: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	30, // 27: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	74, // 28: gramophile.StoredUser.user:type_name -> discogs.User
	75, // 29: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	76, // 30: gramophile.StoredUser.folders:type_name -> discogs.Folder
	77, // 31: gramophile.StoredUser.moves:type_name -> gramophile.FolderMove
	32, // 32: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	30, // 33: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	75, // 34: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	10, // 35: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	45, // 36: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	46, // 37: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	44, // 38: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	8,  // 39: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	8,  // 40: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	78, // 41: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	0,  // 42: gramophile.AddWantlistRequest.type:type_name -> gramophile.WantlistType
	6,  // 43: gramophile.GetWantsResponse.wants:type_name -> gramophile.Want
	4,  // 44: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	29, // 45: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	29, // 46: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	25, // 47: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	25, // 48: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	27, // 49: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	33, // 50: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	35, // 51: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	64, // 52: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	37, // 53: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	39, // 54: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	41, // 55: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	43, // 56: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	48, // 57: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	50, // 58: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	60, // 59: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	56, // 60: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	58, // 61: gramophile.GramophileEService.DeleteWant:input_type -> gramophile.DeleteWantRequest
	52, // 62: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	62, // 63: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	54, // 64: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	66, // 65: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	68, // 66: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	70, // 67: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	26, // 68: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	26, // 69: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	28, // 70: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	34, // 71: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	36, // 72: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	65, // 73: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	38, // 74: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	40, // 75: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	42, // 76: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	47, // 77: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	49, // 78: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	51, // 79: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	61, // 80: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	57, // 81: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	59, // 82: gramophile.GramophileEService.DeleteWant:output_type -> gramophile.DeleteWantResponse
	53, // 83: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	63, // 84: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	55, // 85: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	67, // 86: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	69, // 87: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	71, // 88: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
