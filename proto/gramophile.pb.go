...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x9a, 0x03, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x2a, 0x0a, 0x07, 0x72, 0x65,
	...
	0x52, 0x06, 0x69, 0x73, 0x73, 0x75, 0x65, 0x73, 0x12, 0x32, 0x0a, 0x07, 0x75, 0x70, 0x64, 0x61,
	...
	0x61, 0x74, 0x65, 0x52, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x22, 0x5e, 0x0a, 0x06,
	...
	0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x05, 0x77, 0x69, 0x64, 0x74, 0x68, 0x22, 0x33, 0x0a, 0x06,
	...
	0x65, 0x6e, 0x74, 0x73, 0x22, 0xd3, 0x02, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6c,
	...
	0x73, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x26, 0x0a, 0x10, 0x52, 0x65,
	...
	0x74, 0x68, 0x22, 0x2c, 0x0a, 0x16, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x43, 0x6f, 0x6c,
	...
	0x73, 0x22, 0xe7, 0x02, 0x0a, 0x0a, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72,
	...
	0x66, 0x69, 0x67, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x26, 0x0a, 0x0e, 0x47,
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x95, 0x02, 0x0a,
	...
	0x73, 0x73, 0x65, 0x73, 0x22, 0x48, 0x0a, 0x10, 0x53, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*RefreshIntents)(nil),         // 9: gramophile.RefreshIntents
	(*EnqueueRequest)(nil),         // 10: gramophile.EnqueueRequest
	(*EnqueueResponse)(nil),        // 11: gramophile.EnqueueResponse
	(*ListRequest)(nil),            // 12: gramophile.ListRequest
	(*ListResponse)(nil),           // 13: gramophile.ListResponse
	(*StoredUser)(nil),             // 14: gramophile.StoredUser
	(*GramophileAuth)(nil),         // 15: gramophile.GramophileAuth
	(*UserLoginAttempts)(nil),      // 16: gramophile.UserLoginAttempts
	(*UserLoginAttempt)(nil),       // 17: gramophile.UserLoginAttempt
	(*GetURLRequest)(nil),          // 18: gramophile.GetURLRequest
	(*GetURLResponse)(nil),         // 19: gramophile.GetURLResponse
	(*GetLoginRequest)(nil),        // 20: gramophile.GetLoginRequest
	(*GetLoginResponse)(nil),       // 21: gramophile.GetLoginResponse
	(*GetStateRequest)(nil),        // 22: gramophile.GetStateRequest
	(*GetStateResponse)(nil),       // 23: gramophile.GetStateResponse
	(*SetConfigRequest)(nil),       // 24: gramophile.SetConfigRequest
	(*SetConfigResponse)(nil),      // 25: gramophile.SetConfigResponse
	(*SetIntentRequest)(nil),       // 26: gramophile.SetIntentRequest
	(*SetIntentResponse)(nil),      // 27: gramophile.SetIntentResponse
	(*GetRecordRequest)(nil),       // 28: gramophile.GetRecordRequest
	(*GetRecordWithId)(nil),        // 29: gramophile.GetRecordWithId
	(*GetRecordWithIssue)(nil),     // 30: gramophile.GetRecordWithIssue
	(*GetRecordToListenTo)(nil),    // 31: gramophile.GetRecordToListenTo
	(*GetRecordResponse)(nil),      // 32: gramophile.GetRecordResponse
	(*GetOrgRequest)(nil),          // 33: gramophile.GetOrgRequest
	(*GetOrgResponse)(nil),         // 34: gramophile.GetOrgResponse
	(*SetOrgSnapshotRequest)(nil),  // 35: gramophile.SetOrgSnapshotRequest
	(*SetOrgSnapshotResponse)(nil), // 36: gramophile.SetOrgSnapshotResponse
	(*GetUserRequest)(nil),         // 37: gramophile.GetUserRequest
	(*GetUserResponse)(nil),        // 38: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),        // 39: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),       // 40: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),      // 41: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil),     // 42: gramophile.DeleteUserResponse
	(*CleanRequest)(nil),           // 43: gramophile.CleanRequest
	(*CleanResponse)(nil),          // 44: gramophile.CleanResponse
	(*proto.Release)(nil),          // 45: discogs.Release
	(*proto.User)(nil),             // 46: discogs.User
	(*GramophileConfig)(nil),       // 47: gramophile.GramophileConfig
	(*OrganisationSnapshot)(nil),   // 48: gramophile.OrganisationSnapshot
}
var file_gramophile_proto_depIdxs = []int32{
	...
	45, // 2: gramophile.Record.release:type_name -> discogs.Release
	...
	9,  // 9: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	...
	15, // 12: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	46, // 13: gramophile.StoredUser.user:type_name -> discogs.User
	47, // 14: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	17, // 15: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	15, // 16: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	47, // 17: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	3,  // 18: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	30, // 19: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	31, // 20: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	29, // 21: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	2,  // 22: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	2,  // 23: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	48, // 24: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	14, // 25: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	14, // 26: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	10, // 27: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	10, // 28: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	12, // 29: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	18, // 30: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	20, // 31: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	37, // 32: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	22, // 33: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	24, // 34: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	26, // 35: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	28, // 36: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	33, // 37: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	35, // 38: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	39, // 39: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	41, // 40: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	43, // 41: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	11, // 42: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	11, // 43: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	13, // 44: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	19, // 45: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	21, // 46: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	38, // 47: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	23, // 48: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	25, // 49: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	27, // 50: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	32, // 51: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	34, // 52: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	36, // 53: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	40, // 54: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	42, // 55: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	44, // 56: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
...
func file_gramophile_proto_init() {
	...
	file_gramophile_proto_msgTypes[27].OneofWrappers = []interface{}{
