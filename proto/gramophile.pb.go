...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x22, 0xf8, 0x06, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6c, 0x65, 0x6d,
	...
	0x65, 0x53, 0x61, 0x6c, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68,
	0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x72, 0x65, 0x66, 0x72, 0x65,
	0x73, 0x68, 0x49, 0x64, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x25, 0x0a,
	...
	0x6c, 0x65, 0x49, 0x64, 0x22, 0x0e, 0x0a, 0x0c, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x57,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 69)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*RefreshWants)(nil),           // 15: gramophile.RefreshWants
	(*AddWant)(nil),                // 16: gramophile.AddWant
	(*RefreshWantlists)(nil),       // 17: gramophile.RefreshWantlists
	(*LinkSales)(nil),              // 18: gramophile.LinkSales
	(*RefreshSales)(nil),           // 19: gramophile.RefreshSales
	(*AddFolderUpdate)(nil),        // 20: gramophile.AddFolderUpdate
	(*RefreshUpdates)(nil),         // 21: gramophile.RefreshUpdates
	(*RefreshUserEntry)(nil),       // 22: gramophile.RefreshUserEntry
	(*RefreshCollectionEntry)(nil), // 23: gramophile.RefreshCollectionEntry
	(*CleanCollectionEntry)(nil),   // 24: gramophile.CleanCollectionEntry
	(*RefreshIntents)(nil),         // 25: gramophile.RefreshIntents
	(*EnqueueRequest)(nil),         // 26: gramophile.EnqueueRequest
	(*EnqueueResponse)(nil),        // 27: gramophile.EnqueueResponse
	(*ListRequest)(nil),            // 28: gramophile.ListRequest
	(*ListResponse)(nil),           // 29: gramophile.ListResponse
	(*StoredUser)(nil),             // 30: gramophile.StoredUser
	(*GramophileAuth)(nil),         // 31: gramophile.GramophileAuth
	(*UserLoginAttempts)(nil),      // 32: gramophile.UserLoginAttempts
	(*UserLoginAttempt)(nil),       // 33: gramophile.UserLoginAttempt
	(*GetURLRequest)(nil),          // 34: gramophile.GetURLRequest
	(*GetURLResponse)(nil),         // 35: gramophile.GetURLResponse
	(*GetLoginRequest)(nil),        // 36: gramophile.GetLoginRequest
	(*GetLoginResponse)(nil),       // 37: gramophile.GetLoginResponse
	(*GetStateRequest)(nil),        // 38: gramophile.GetStateRequest
	(*GetStateResponse)(nil),       // 39: gramophile.GetStateResponse
	(*SetConfigRequest)(nil),       // 40: gramophile.SetConfigRequest
	(*SetConfigResponse)(nil),      // 41: gramophile.SetConfigResponse
	(*SetIntentRequest)(nil),       // 42: gramophile.SetIntentRequest
	(*SetIntentResponse)(nil),      // 43: gramophile.SetIntentResponse
	(*GetRecordRequest)(nil),       // 44: gramophile.GetRecordRequest
	(*GetRecordWithId)(nil),        // 45: gramophile.GetRecordWithId
	(*GetRecordWithIssue)(nil),     // 46: gramophile.GetRecordWithIssue
	(*GetRecordToListenTo)(nil),    // 47: gramophile.GetRecordToListenTo
	(*GetRecordResponse)(nil),      // 48: gramophile.GetRecordResponse
	(*GetOrgRequest)(nil),          // 49: gramophile.GetOrgRequest
	(*GetOrgResponse)(nil),         // 50: gramophile.GetOrgResponse
	(*SetOrgSnapshotRequest)(nil),  // 51: gramophile.SetOrgSnapshotRequest
	(*SetOrgSnapshotResponse)(nil), // 52: gramophile.SetOrgSnapshotResponse
	(*AddWantlistRequest)(nil),     // 53: gramophile.AddWantlistRequest
	(*AddWantlistResponse)(nil),    // 54: gramophile.AddWantlistResponse
	(*UpdateWantlistRequest)(nil),  // 55: gramophile.UpdateWantlistRequest
	(*UpdateWantlistResponse)(nil), // 56: gramophile.UpdateWantlistResponse
	(*GetWantsRequest)(nil),        // 57: gramophile.GetWantsRequest
	(*GetWantsResponse)(nil),       // 58: gramophile.GetWantsResponse
	(*DeleteWantRequest)(nil),      // 59: gramophile.DeleteWantRequest
	(*DeleteWantResponse)(nil),     // 60: gramophile.DeleteWantResponse
	(*AddWantRequest)(nil),         // 61: gramophile.AddWantRequest
	(*AddWantResponse)(nil),        // 62: gramophile.AddWantResponse
	(*GetWantlistRequest)(nil),     // 63: gramophile.GetWantlistRequest
	(*GetWantlistResponse)(nil),    // 64: gramophile.GetWantlistResponse
	(*GetUserRequest)(nil),         // 65: gramophile.GetUserRequest
	(*GetUserResponse)(nil),        // 66: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),        // 67: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),       // 68: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),      // 69: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil),     // 70: gramophile.DeleteUserResponse
	(*CleanRequest)(nil),           // 71: gramophile.CleanRequest
	(*CleanResponse)(nil),          // 72: gramophile.CleanResponse
	(*proto.Release)(nil),          // 73: discogs.Release
	(proto.SaleStatus)(0),          // 74: discogs.SaleStatus
	(*proto.Price)(nil),            // 75: discogs.Price
	(*proto.User)(nil),             // 76: discogs.User
	(*GramophileConfig)(nil),       // 77: gramophile.GramophileConfig
	(*proto.Folder)(nil),           // 78: discogs.Folder
	(*FolderMove)(nil),             // 79: gramophile.FolderMove
	(*OrganisationSnapshot)(nil),   // 80: gramophile.OrganisationSnapshot
}
var file_gramophile_proto_depIdxs = []int32{
	...
	73, // 6: gramophile.Record.release:type_name -> discogs.Release
	...
	74, // 11: gramophile.SaleInfo.sale_state:type_name -> discogs.SaleStatus
	75, // 12: gramophile.SaleInfo.currentPrice:type_name -> discogs.Price
	...
	22, // 16: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	23, // 17: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollectionEntry
	25, // 18: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	21, // 19: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	20, // 20: gramophile.QueueElement.add_folder_update:type_name -> gramophile.AddFolderUpdate
	19, // 21: gramophile.QueueElement.refresh_sales:type_name -> gramophile.RefreshSales
	18, // 22: gramophile.QueueElement.link_sales:type_name -> gramophile.LinkSales
	17, // 23: gramophile.QueueElement.refresh_wantlists:type_name -> gramophile.RefreshWantlists
	16, // 24: gramophile.QueueElement.add_want:type_name -> gramophile.AddWant
	15, // 25: gramophile.QueueElement.refresh_wants:type_name -> gramophile.RefreshWants
	14, // 26: gramophile.QueueElement.update_sale:type_name -> gramophile.UpdateSale
	13, // 27: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	13, // 28: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	31, // 29: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	76, // 30: gramophile.StoredUser.user:type_name -> discogs.User
	77, // 31: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	78, // 32: gramophile.StoredUser.folders:type_name -> discogs.Folder
	79, // 33: gramophile.StoredUser.moves:type_name -> gramophile.FolderMove
	33, // 34: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	31, // 35: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	77, // 36: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	10, // 37: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	46, // 38: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	47, // 39: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	45, // 40: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	8,  // 41: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	8,  // 42: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	80, // 43: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	0,  // 44: gramophile.AddWantlistRequest.type:type_name -> gramophile.WantlistType
	6,  // 45: gramophile.GetWantsResponse.wants:type_name -> gramophile.Want
	4,  // 46: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	30, // 47: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	30, // 48: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	26, // 49: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	26, // 50: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	28, // 51: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	34, // 52: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	36, // 53: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	65, // 54: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	38, // 55: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	40, // 56: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	42, // 57: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	44, // 58: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	49, // 59: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	51, // 60: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	61, // 61: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	57, // 62: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	59, // 63: gramophile.GramophileEService.DeleteWant:input_type -> gramophile.DeleteWantRequest
	53, // 64: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	63, // 65: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	55, // 66: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	67, // 67: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	69, // 68: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	71, // 69: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	27, // 70: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	27, // 71: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	29, // 72: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	35, // 73: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	37, // 74: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	66, // 75: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	39, // 76: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	41, // 77: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	43, // 78: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	48, // 79: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	50, // 80: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	52, // 81: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	62, // 82: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	58, // 83: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	60, // 84: gramophile.GramophileEService.DeleteWant:output_type -> gramophile.DeleteWantResponse
	54, // 85: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	64, // 86: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	56, // 87: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	68, // 88: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	70, // 89: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	72, // 90: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
...
func file_gramophile_proto_init() {
	...
	file_gramophile_proto_msgTypes[40].OneofWrappers = []interface{}{
