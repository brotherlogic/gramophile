...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xca, 0x05, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6c, 0x65, 0x6d, 0x65,
	...
	0x74, 0x6c, 0x69, 0x73, 0x74, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73,
	0x68, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x72, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x49, 0x64, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x12,
	...
	0x54, 0x45, 0x5f, 0x42, 0x4f, 0x55, 0x4e, 0x44, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x33, 0x0a, 0x09,
	0x57, 0x61, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0a, 0x0a, 0x06, 0x57, 0x41, 0x4e,
	0x54, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x45, 0x54, 0x49, 0x52, 0x45, 0x44,
	0x10, 0x01, 0x12, 0x0d, 0x0a, 0x09, 0x50, 0x55, 0x52, 0x43, 0x48, 0x41, 0x53, 0x45, 0x44, 0x10,
	0x02, 0x2a, 0x25, 0x0a, 0x12, 0x4e, 0x6f, 0x6e, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x69, 0x61, 0x6e,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*RefreshWantlists)(nil),       // 14: gramophile.RefreshWantlists
	(*LinkSales)(nil),              // 15: gramophile.LinkSales
	(*RefreshSales)(nil),           // 16: gramophile.RefreshSales
	(*AddFolderUpdate)(nil),        // 17: gramophile.AddFolderUpdate
	(*RefreshUpdates)(nil),         // 18: gramophile.RefreshUpdates
	(*RefreshUserEntry)(nil),       // 19: gramophile.RefreshUserEntry
	(*RefreshCollectionEntry)(nil), // 20: gramophile.RefreshCollectionEntry
	(*CleanCollectionEntry)(nil),   // 21: gramophile.CleanCollectionEntry
	(*RefreshIntents)(nil),         // 22: gramophile.RefreshIntents
	(*EnqueueRequest)(nil),         // 23: gramophile.EnqueueRequest
	(*EnqueueResponse)(nil),        // 24: gramophile.EnqueueResponse
	(*ListRequest)(nil),            // 25: gramophile.ListRequest
	(*ListResponse)(nil),           // 26: gramophile.ListResponse
	(*StoredUser)(nil),             // 27: gramophile.StoredUser
	(*GramophileAuth)(nil),         // 28: gramophile.GramophileAuth
	(*UserLoginAttempts)(nil),      // 29: gramophile.UserLoginAttempts
	(*UserLoginAttempt)(nil),       // 30: gramophile.UserLoginAttempt
	(*GetURLRequest)(nil),          // 31: gramophile.GetURLRequest
	(*GetURLResponse)(nil),         // 32: gramophile.GetURLResponse
	(*GetLoginRequest)(nil),        // 33: gramophile.GetLoginRequest
	(*GetLoginResponse)(nil),       // 34: gramophile.GetLoginResponse
	(*GetStateRequest)(nil),        // 35: gramophile.GetStateRequest
	(*GetStateResponse)(nil),       // 36: gramophile.GetStateResponse
	(*SetConfigRequest)(nil),       // 37: gramophile.SetConfigRequest
	(*SetConfigResponse)(nil),      // 38: gramophile.SetConfigResponse
	(*SetIntentRequest)(nil),       // 39: gramophile.SetIntentRequest
	(*SetIntentResponse)(nil),      // 40: gramophile.SetIntentResponse
	(*GetRecordRequest)(nil),       // 41: gramophile.GetRecordRequest
	(*GetRecordWithId)(nil),        // 42: gramophile.GetRecordWithId
	(*GetRecordWithIssue)(nil),     // 43: gramophile.GetRecordWithIssue
	(*GetRecordToListenTo)(nil),    // 44: gramophile.GetRecordToListenTo
	(*GetRecordResponse)(nil),      // 45: gramophile.GetRecordResponse
	(*GetOrgRequest)(nil),          // 46: gramophile.GetOrgRequest
	(*GetOrgResponse)(nil),         // 47: gramophile.GetOrgResponse
	(*SetOrgSnapshotRequest)(nil),  // 48: gramophile.SetOrgSnapshotRequest
	(*SetOrgSnapshotResponse)(nil), // 49: gramophile.SetOrgSnapshotResponse
	(*AddWantlistRequest)(nil),     // 50: gramophile.AddWantlistRequest
	(*AddWantlistResponse)(nil),    // 51: gramophile.AddWantlistResponse
	(*UpdateWantlistRequest)(nil),  // 52: gramophile.UpdateWantlistRequest
	(*UpdateWantlistResponse)(nil), // 53: gramophile.UpdateWantlistResponse
	(*GetWantsRequest)(nil),        // 54: gramophile.GetWantsRequest
	(*GetWantsResponse)(nil),       // 55: gramophile.GetWantsResponse
	(*DeleteWantRequest)(nil),      // 56: gramophile.DeleteWantRequest
	(*DeleteWantResponse)(nil),     // 57: gramophile.DeleteWantResponse
	(*AddWantRequest)(nil),         // 58: gramophile.AddWantRequest
	(*AddWantResponse)(nil),        // 59: gramophile.AddWantResponse
	(*GetWantlistRequest)(nil),     // 60: gramophile.GetWantlistRequest
	(*GetWantlistResponse)(nil),    // 61: gramophile.GetWantlistResponse
	(*GetUserRequest)(nil),         // 62: gramophile.GetUserRequest
	(*GetUserResponse)(nil),        // 63: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),        // 64: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),       // 65: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),      // 66: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil),     // 67: gramophile.DeleteUserResponse
	(*CleanRequest)(nil),           // 68: gramophile.CleanRequest
	(*CleanResponse)(nil),          // 69: gramophile.CleanResponse
	(*proto.Release)(nil),          // 70: discogs.Release
	(proto.SaleStatus)(0),          // 71: discogs.SaleStatus
	(*proto.User)(nil),             // 72: discogs.User
	(*GramophileConfig)(nil),       // 73: gramophile.GramophileConfig
	(*proto.Folder)(nil),           // 74: discogs.Folder
	(*FolderMove)(nil),             // 75: gramophile.FolderMove
	(*OrganisationSnapshot)(nil),   // 76: gramophile.OrganisationSnapshot
}
var file_gramophile_proto_depIdxs = []int32{
	...
	70, // 6: gramophile.Record.release:type_name -> discogs.Release
	...
	71, // 11: gramophile.SaleInfo.sale_state:type_name -> discogs.SaleStatus
	...
	19, // 15: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	20, // 16: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollectionEntry
	22, // 17: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	18, // 18: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	17, // 19: gramophile.QueueElement.add_folder_update:type_name -> gramophile.AddFolderUpdate
	16, // 20: gramophile.QueueElement.refresh_sales:type_name -> gramophile.RefreshSales
	15, // 21: gramophile.QueueElement.link_sales:type_name -> gramophile.LinkSales
	14, // 22: gramophile.QueueElement.refresh_wantlists:type_name -> gramophile.RefreshWantlists
	13, // 23: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	13, // 24: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	28, // 25: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	72, // 26: gramophile.StoredUser.user:type_name -> discogs.User
	73, // 27: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	74, // 28: gramophile.StoredUser.folders:type_name -> discogs.Folder
	75, // 29: gramophile.StoredUser.moves:type_name -> gramophile.FolderMove
	30, // 30: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	28, // 31: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	73, // 32: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	10, // 33: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	43, // 34: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	44, // 35: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	42, // 36: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	8,  // 37: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	8,  // 38: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	76, // 39: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	0,  // 40: gramophile.AddWantlistRequest.type:type_name -> gramophile.WantlistType
	6,  // 41: gramophile.GetWantsResponse.wants:type_name -> gramophile.Want
	4,  // 42: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	27, // 43: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	27, // 44: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	23, // 45: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	23, // 46: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	25, // 47: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	31, // 48: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	33, // 49: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	62, // 50: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	35, // 51: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	37, // 52: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	39, // 53: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	41, // 54: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	46, // 55: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	48, // 56: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	58, // 57: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	54, // 58: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	56, // 59: gramophile.GramophileEService.DeleteWant:input_type -> gramophile.DeleteWantRequest
	50, // 60: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	60, // 61: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	52, // 62: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	64, // 63: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	66, // 64: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	68, // 65: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	24, // 66: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	24, // 67: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	26, // 68: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	32, // 69: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	34, // 70: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	63, // 71: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	36, // 72: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	38, // 73: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	40, // 74: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	45, // 75: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	47, // 76: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	49, // 77: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	59, // 78: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	55, // 79: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	57, // 80: gramophile.GramophileEService.DeleteWant:output_type -> gramophile.DeleteWantResponse
	51, // 81: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	61, // 82: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	53, // 83: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	65, // 84: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	67, // 85: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	69, // 86: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
...
func file_gramophile_proto_init() {
	...
	file_gramophile_proto_msgTypes[37].OneofWrappers = []interface{}{
