...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xe6, 0x0b, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75,
	...
	0x72, 0x65, 0x73, 0x68, 0x57, 0x61, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x66, 0x72,
	...
	0x22, 0x26, 0x0a, 0x0b, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x57, 0x61, 0x6e, 0x74, 0x12,
	0x17, 0x0a, 0x07, 0x77, 0x61, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x06, 0x77, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x3e, 0x0a, 0x09, 0x53, 0x79, 0x6e, 0x63,
	...
	0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x49, 0x64, 0x22, 0x4c, 0x0a, 0x1b, 0x52, 0x65, 0x66, 0x72,
	...
	0x74, 0x68, 0x65, 0x72, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x22, 0x13, 0x0a, 0x11, 0x52,
	0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x22, 0x22, 0x0a, 0x0e, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x52, 0x65, 0x6c, 0x65, 0x61,
	0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x03, 0x69, 0x69, 0x64, 0x22, 0x7f, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x61,
	...
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x5f, 0x0a, 0x0a, 0x4d, 0x6f, 0x76, 0x65, 0x52, 0x65, 0x63,
	...
	0x57, 0x61, 0x6e, 0x74, 0x73, 0x22, 0x19, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x57, 0x61, 0x6e, 0x74,
	...
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xec, 0x03, 0x0a, 0x0a, 0x53, 0x74, 0x6f, 0x72, 0x65,
	...
	0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x51, 0x0a, 0x0f, 0x47, 0x65, 0x74,
	...
	0x72, 0x22, 0x6d, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x65,
	...
	0x72, 0x64, 0x12, 0x2c, 0x0a, 0x07, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x18, 0x02, 0x20,
...
var file_gramophile_proto_depIdxs = []int32{
	...
	83, // 12: gramophile.Record.median_price:type_name -> discogs.Price
	84, // 13: gramophile.SaleInfo.sale_state:type_name -> discogs.SaleStatus
	83, // 14: gramophile.SaleInfo.currentPrice:type_name -> discogs.Price
	83, // 15: gramophile.SaleInfo.initialPrice:type_name -> discogs.Price
	83, // 16: gramophile.SaleInfo.medianPrice:type_name -> discogs.Price
	...
	31, // 20: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	32, // 21: gramophile.QueueElement.refresh_collection_entry:type_name -> gramophile.RefreshCollectionEntry
	34, // 22: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	30, // 23: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	29, // 24: gramophile.QueueElement.add_folder_update:type_name -> gramophile.AddFolderUpdate
	28, // 25: gramophile.QueueElement.refresh_sales:type_name -> gramophile.RefreshSales
	27, // 26: gramophile.QueueElement.link_sales:type_name -> gramophile.LinkSales
	26, // 27: gramophile.QueueElement.refresh_wantlists:type_name -> gramophile.RefreshWantlists
	25, // 28: gramophile.QueueElement.add_want:type_name -> gramophile.AddWant
	24, // 29: gramophile.QueueElement.refresh_wants:type_name -> gramophile.RefreshWants
	21, // 30: gramophile.QueueElement.update_sale:type_name -> gramophile.UpdateSale
	23, // 31: gramophile.QueueElement.move_records:type_name -> gramophile.MoveRecords
	22, // 32: gramophile.QueueElement.move_record:type_name -> gramophile.MoveRecord
	20, // 33: gramophile.QueueElement.refresh_release:type_name -> gramophile.RefreshRelease
	19, // 34: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollection
	17, // 35: gramophile.QueueElement.refresh_earliest_release_dates:type_name -> gramophile.RefreshEarliestReleaseDates
	18, // 36: gramophile.QueueElement.refresh_earliest_release_date:type_name -> gramophile.RefreshEarliestReleaseDate
	16, // 37: gramophile.QueueElement.sync_wants:type_name -> gramophile.SyncWants
	15, // 38: gramophile.QueueElement.refresh_want:type_name -> gramophile.RefreshWant
	14, // 39: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	14, // 40: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	40, // 41: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	85, // 42: gramophile.StoredUser.user:type_name -> discogs.User
	86, // 43: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	87, // 44: gramophile.StoredUser.folders:type_name -> discogs.Folder
	88, // 45: gramophile.StoredUser.moves:type_name -> gramophile.FolderMove
	42, // 46: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	40, // 47: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	86, // 48: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	11, // 49: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	55, // 50: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	56, // 51: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	54, // 52: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	9,  // 53: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	9,  // 54: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	89, // 55: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	0,  // 56: gramophile.AddWantlistRequest.type:type_name -> gramophile.WantlistType
	1,  // 57: gramophile.AddWantlistRequest.visibility:type_name -> gramophile.WantlistVisibility
	7,  // 58: gramophile.GetWantsResponse.wants:type_name -> gramophile.Want
	5,  // 59: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	39, // 60: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	39, // 61: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	35, // 62: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	35, // 63: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	37, // 64: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	43, // 65: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	45, // 66: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	74, // 67: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	47, // 68: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	49, // 69: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	51, // 70: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	53, // 71: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	58, // 72: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	60, // 73: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	70, // 74: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	66, // 75: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	68, // 76: gramophile.GramophileEService.DeleteWant:input_type -> gramophile.DeleteWantRequest
	62, // 77: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	72, // 78: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	64, // 79: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	76, // 80: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	78, // 81: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	80, // 82: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	36, // 83: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	36, // 84: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	38, // 85: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	44, // 86: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	46, // 87: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	75, // 88: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	48, // 89: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	50, // 90: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	52, // 91: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	57, // 92: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	59, // 93: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	61, // 94: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	71, // 95: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	67, // 96: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	69, // 97: gramophile.GramophileEService.DeleteWant:output_type -> gramophile.DeleteWantResponse
	63, // 98: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	73, // 99: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	65, // 100: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	77, // 101: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	79, // 102: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	81, // 103: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
