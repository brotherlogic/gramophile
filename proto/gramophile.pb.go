...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x73, 0x22, 0x8c, 0x02, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6c, 0x65,
	...
	0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x6e, 0x74,
	...
	0x28, 0x05, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x22, 0x44, 0x0a, 0x0e, 0x45, 0x6e, 0x71, 0x75,
	...
	0x65, 0x22, 0xe7, 0x02, 0x0a, 0x0a, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72,
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xe8, 0x01, 0x0a,
	...
	0x66, 0x69, 0x67, 0x48, 0x61, 0x73, 0x68, 0x22, 0x48, 0x0a, 0x10, 0x53, 0x65, 0x74, 0x43, 0x6f,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x25, 0x0a, 0x12, 0x4e, 0x6f, 0x6e, 0x63, 0x6f,
	0x6d, 0x70, 0x6c, 0x69, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x73, 0x73, 0x75, 0x65, 0x12, 0x0f, 0x0a,
	0x0b, 0x4e, 0x45, 0x45, 0x44, 0x53, 0x5f, 0x43, 0x4c, 0x45, 0x41, 0x4e, 0x10, 0x00, 0x32, 0x9a,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0xfb, 0x02, 0x0a, 0x12,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0xab, 0x01, 0x0a, 0x11, 0x47, 0x72,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*EnqueueRequest)(nil),         // 8: gramophile.EnqueueRequest
	(*EnqueueResponse)(nil),        // 9: gramophile.EnqueueResponse
	(*StoredUser)(nil),             // 10: gramophile.StoredUser
	(*GramophileAuth)(nil),         // 11: gramophile.GramophileAuth
	(*UserLoginAttempts)(nil),      // 12: gramophile.UserLoginAttempts
	(*UserLoginAttempt)(nil),       // 13: gramophile.UserLoginAttempt
	(*GetURLRequest)(nil),          // 14: gramophile.GetURLRequest
	(*GetURLResponse)(nil),         // 15: gramophile.GetURLResponse
	(*GetLoginRequest)(nil),        // 16: gramophile.GetLoginRequest
	(*GetLoginResponse)(nil),       // 17: gramophile.GetLoginResponse
	(*GetStateRequest)(nil),        // 18: gramophile.GetStateRequest
	(*GetStateResponse)(nil),       // 19: gramophile.GetStateResponse
	(*SetConfigRequest)(nil),       // 20: gramophile.SetConfigRequest
	(*SetConfigResponse)(nil),      // 21: gramophile.SetConfigResponse
	(*GetUserRequest)(nil),         // 22: gramophile.GetUserRequest
	(*GetUserResponse)(nil),        // 23: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),        // 24: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),       // 25: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),      // 26: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil),     // 27: gramophile.DeleteUserResponse
	(*proto.Release)(nil),          // 28: discogs.Release
	(*proto.User)(nil),             // 29: discogs.User
	(*GramophileConfig)(nil),       // 30: gramophile.GramophileConfig
}
var file_gramophile_proto_depIdxs = []int32{
	28, // 0: gramophile.Record.release:type_name -> discogs.Release
	...
	5,  // 6: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	11, // 7: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	29, // 8: gramophile.StoredUser.user:type_name -> discogs.User
	30, // 9: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	13, // 10: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	11, // 11: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	30, // 12: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	10, // 13: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	10, // 14: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	8,  // 15: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	8,  // 16: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	14, // 17: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	16, // 18: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	22, // 19: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	18, // 20: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	20, // 21: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	24, // 22: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	26, // 23: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	9,  // 24: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	9,  // 25: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	15, // 26: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	17, // 27: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	23, // 28: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	19, // 29: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	21, // 30: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	25, // 31: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	27, // 32: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
