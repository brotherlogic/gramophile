...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*GetUserRequest)(nil),    // 8: gramophile.GetUserRequest
	(*GetUserResponse)(nil),   // 9: gramophile.GetUserResponse
	(*proto.User)(nil),        // 10: discogs.User
}
var file_gramophile_proto_depIdxs = []int32{
	1,  // 0: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	10, // 1: gramophile.StoredUser.user:type_name -> discogs.User
	...
	0,  // 4: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	4,  // 5: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	6,  // 6: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	8,  // 7: gramophile.GramophileService.GetUser:input_type -> gramophile.GetUserRequest
	5,  // 8: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	7,  // 9: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	9,  // 10: gramophile.GramophileService.GetUser:output_type -> gramophile.GetUserResponse
