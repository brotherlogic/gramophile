...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x22, 0x33, 0x0a, 0x06, 0x51, 0x75, 0x65, 0x75, 0x65, 0x73, 0x12, 0x29, 0x0a, 0x06,
	...
	0x52, 0x08, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x8c, 0x02, 0x0a, 0x0c, 0x51,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xe7, 0x02, 0x0a, 0x0a, 0x53, 0x74, 0x6f,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x34, 0x0a, 0x06,
	...
	0x69, 0x67, 0x22, 0x26, 0x0a, 0x0e, 0x47, 0x72, 0x61, 0x6d, 0x6f, 0x70, 0x68, 0x69, 0x6c, 0x65,
	...
	0x65, 0x73, 0x74, 0x22, 0xe8, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x28, 0x09, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x61, 0x73, 0x68, 0x22, 0x10,
	...
	0x65, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a,
	...
	0x4c, 0x45, 0x41, 0x4e, 0x10, 0x00, 0x32, 0x9a, 0x01, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65,
	...
	0x65, 0x22, 0x00, 0x32, 0xaf, 0x02, 0x0a, 0x12, 0x47, 0x72, 0x61, 0x6d, 0x6f, 0x70, 0x68, 0x69,
...
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*Queues)(nil),                 // 2: gramophile.Queues
	(*Queue)(nil),                  // 3: gramophile.Queue
	(*QueueElement)(nil),           // 4: gramophile.QueueElement
	(*RefreshUserEntry)(nil),       // 5: gramophile.RefreshUserEntry
	(*RefreshCollectionEntry)(nil), // 6: gramophile.RefreshCollectionEntry
	(*EnqueueRequest)(nil),         // 7: gramophile.EnqueueRequest
	(*EnqueueResponse)(nil),        // 8: gramophile.EnqueueResponse
	(*StoredUser)(nil),             // 9: gramophile.StoredUser
	(*GramophileAuth)(nil),         // 10: gramophile.GramophileAuth
	(*UserLoginAttempts)(nil),      // 11: gramophile.UserLoginAttempts
	(*UserLoginAttempt)(nil),       // 12: gramophile.UserLoginAttempt
	(*GetURLRequest)(nil),          // 13: gramophile.GetURLRequest
	(*GetURLResponse)(nil),         // 14: gramophile.GetURLResponse
	(*GetLoginRequest)(nil),        // 15: gramophile.GetLoginRequest
	(*GetLoginResponse)(nil),       // 16: gramophile.GetLoginResponse
	(*GetStateRequest)(nil),        // 17: gramophile.GetStateRequest
	(*GetStateResponse)(nil),       // 18: gramophile.GetStateResponse
	(*GetUserRequest)(nil),         // 19: gramophile.GetUserRequest
	(*GetUserResponse)(nil),        // 20: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),        // 21: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),       // 22: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),      // 23: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil),     // 24: gramophile.DeleteUserResponse
	(*proto.Release)(nil),          // 25: discogs.Release
	(*proto.User)(nil),             // 26: discogs.User
	(*GramophileConfig)(nil),       // 27: gramophile.GramophileConfig
}
var file_gramophile_proto_depIdxs = []int32{
	25, // 0: gramophile.Record.release:type_name -> discogs.Release
	0,  // 1: gramophile.Record.issues:type_name -> gramophile.NoncomplianceIssue
	3,  // 2: gramophile.Queues.queues:type_name -> gramophile.Queue
	4,  // 3: gramophile.Queue.elements:type_name -> gramophile.QueueElement
	5,  // 4: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	6,  // 5: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollectionEntry
	4,  // 6: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	10, // 7: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	26, // 8: gramophile.StoredUser.user:type_name -> discogs.User
	27, // 9: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	12, // 10: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	10, // 11: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	9,  // 12: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	9,  // 13: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	7,  // 14: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	7,  // 15: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	13, // 16: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	15, // 17: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	19, // 18: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	17, // 19: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	21, // 20: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	23, // 21: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	8,  // 22: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	8,  // 23: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	14, // 24: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	16, // 25: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	20, // 26: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	18, // 27: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	22, // 28: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	24, // 29: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
