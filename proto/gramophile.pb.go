...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x22, 0x83, 0x02, 0x0a, 0x0a, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x22, 0x26, 0x0a, 0x0e, 0x47, 0x72, 0x61, 0x6d, 0x6f, 0x70,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x3e, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x53, 0x74,
	...
	0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x22, 0x10, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x54, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75,
	0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x44, 0x0a, 0x07, 0x45, 0x78, 0x65, 0x63,
	...
	0x1b, 0x2e, 0x67, 0x72, 0x61, 0x6d, 0x6f, 0x70, 0x68, 0x69, 0x6c, 0x65, 0x2e, 0x45, 0x78, 0x65,
	0x63, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0xaf,
...
var file_gramophile_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*GetStateRequest)(nil),    // 14: gramophile.GetStateRequest
	(*GetStateResponse)(nil),   // 15: gramophile.GetStateResponse
	(*GetUserRequest)(nil),     // 16: gramophile.GetUserRequest
	(*GetUserResponse)(nil),    // 17: gramophile.GetUserResponse
	(*GetUsersRequest)(nil),    // 18: gramophile.GetUsersRequest
	(*GetUsersResponse)(nil),   // 19: gramophile.GetUsersResponse
	(*DeleteUserRequest)(nil),  // 20: gramophile.DeleteUserRequest
	(*DeleteUserResponse)(nil), // 21: gramophile.DeleteUserResponse
	(*proto.User)(nil),         // 22: discogs.User
}
var file_gramophile_proto_depIdxs = []int32{
	...
	22, // 5: gramophile.StoredUser.user:type_name -> discogs.User
	...
	6,  // 9: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	3,  // 10: gramophile.QueueService.Execute:input_type -> gramophile.ExecuteRequest
	10, // 11: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	12, // 12: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	16, // 13: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	14, // 14: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	18, // 15: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	20, // 16: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	4,  // 17: gramophile.QueueService.Execute:output_type -> gramophile.ExecuteResponse
	11, // 18: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	13, // 19: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	17, // 20: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	15, // 21: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	19, // 22: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	21, // 23: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
