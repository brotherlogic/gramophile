...
var file_gramophile_proto_rawDesc = []byte{
	...
	0xf5, 0x01, 0x0a, 0x08, 0x53, 0x61, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x17, 0x0a, 0x07,
	...
	0x6e, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0xf5, 0x01, 0x0a, 0x06, 0x49, 0x6e, 0x74, 0x65,
	...
	0x65, 0x65, 0x70, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x04, 0x6b, 0x65, 0x65, 0x70, 0x22,
	...
	0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xfd, 0x04, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75,
	...
	0x72, 0x65, 0x73, 0x68, 0x55, 0x73, 0x65, 0x72, 0x12, 0x53, 0x0a, 0x12, 0x72, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x5f, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05,
	...
	0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x48, 0x00, 0x52, 0x11, 0x72, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x45, 0x0a,
	...
	0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x2a, 0x0a, 0x09, 0x4c, 0x69, 0x6e, 0x6b, 0x53,
...
var file_gramophile_proto_goTypes = []interface{}{
	...
	(*proto.Price)(nil),            // 71: discogs.Price
...
var file_gramophile_proto_depIdxs = []int32{
	...
	71, // 11: gramophile.SaleInfo.currentPrice:type_name -> discogs.Price
	...
	18, // 15: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	19, // 16: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollectionEntry
	21, // 17: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	17, // 18: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	16, // 19: gramophile.QueueElement.add_folder_update:type_name -> gramophile.AddFolderUpdate
	15, // 20: gramophile.QueueElement.refresh_sales:type_name -> gramophile.RefreshSales
	14, // 21: gramophile.QueueElement.link_sales:type_name -> gramophile.LinkSales
	13, // 22: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	13, // 23: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	27, // 24: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	72, // 25: gramophile.StoredUser.user:type_name -> discogs.User
	73, // 26: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	74, // 27: gramophile.StoredUser.folders:type_name -> discogs.Folder
	75, // 28: gramophile.StoredUser.moves:type_name -> gramophile.FolderMove
	29, // 29: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	27, // 30: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	73, // 31: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	10, // 32: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	42, // 33: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	43, // 34: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	41, // 35: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	8,  // 36: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	8,  // 37: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	76, // 38: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	0,  // 39: gramophile.AddWantlistRequest.type:type_name -> gramophile.WantlistType
	6,  // 40: gramophile.GetWantsResponse.wants:type_name -> gramophile.Want
	4,  // 41: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	26, // 42: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	26, // 43: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	22, // 44: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	22, // 45: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	24, // 46: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	30, // 47: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	32, // 48: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	61, // 49: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	34, // 50: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	36, // 51: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	38, // 52: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	40, // 53: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	45, // 54: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	47, // 55: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	57, // 56: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	53, // 57: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	55, // 58: gramophile.GramophileEService.DeleteWant:input_type -> gramophile.DeleteWantRequest
	49, // 59: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	59, // 60: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	51, // 61: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	63, // 62: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	65, // 63: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	67, // 64: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	23, // 65: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	23, // 66: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	25, // 67: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	31, // 68: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	33, // 69: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	62, // 70: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	35, // 71: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	37, // 72: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	39, // 73: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	44, // 74: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	46, // 75: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	48, // 76: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	58, // 77: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	54, // 78: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	56, // 79: gramophile.GramophileEService.DeleteWant:output_type -> gramophile.DeleteWantResponse
	50, // 80: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	60, // 81: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	52, // 82: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	64, // 83: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	66, // 84: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	68, // 85: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
