...
var file_gramophile_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x70, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xe8, 0x02, 0x0a, 0x08, 0x53, 0x61,
	...
	0x12, 0x32, 0x0a, 0x0c, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65,
	...
	0x72, 0x69, 0x63, 0x65, 0x22, 0x92, 0x02, 0x0a, 0x06, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12,
	...
	0x73, 0x22, 0xf1, 0x07, 0x0a, 0x0c, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6c, 0x65, 0x6d, 0x65,
	...
	0x00, 0x52, 0x0a, 0x6d, 0x6f, 0x76, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x1d, 0x0a,
	...
	0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x7f, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53,
...
var file_gramophile_proto_depIdxs = []int32{
	...
	77, // 13: gramophile.SaleInfo.initialPrice:type_name -> discogs.Price
	3,  // 14: gramophile.Intent.keep:type_name -> gramophile.KeepStatus
	12, // 15: gramophile.Queues.queues:type_name -> gramophile.Queue
	13, // 16: gramophile.Queue.elements:type_name -> gramophile.QueueElement
	24, // 17: gramophile.QueueElement.refresh_user:type_name -> gramophile.RefreshUserEntry
	25, // 18: gramophile.QueueElement.refresh_collection:type_name -> gramophile.RefreshCollectionEntry
	27, // 19: gramophile.QueueElement.refresh_intents:type_name -> gramophile.RefreshIntents
	23, // 20: gramophile.QueueElement.refresh_updates:type_name -> gramophile.RefreshUpdates
	22, // 21: gramophile.QueueElement.add_folder_update:type_name -> gramophile.AddFolderUpdate
	21, // 22: gramophile.QueueElement.refresh_sales:type_name -> gramophile.RefreshSales
	20, // 23: gramophile.QueueElement.link_sales:type_name -> gramophile.LinkSales
	19, // 24: gramophile.QueueElement.refresh_wantlists:type_name -> gramophile.RefreshWantlists
	18, // 25: gramophile.QueueElement.add_want:type_name -> gramophile.AddWant
	17, // 26: gramophile.QueueElement.refresh_wants:type_name -> gramophile.RefreshWants
	14, // 27: gramophile.QueueElement.update_sale:type_name -> gramophile.UpdateSale
	16, // 28: gramophile.QueueElement.move_records:type_name -> gramophile.MoveRecords
	15, // 29: gramophile.QueueElement.move_record:type_name -> gramophile.MoveRecord
	13, // 30: gramophile.EnqueueRequest.element:type_name -> gramophile.QueueElement
	13, // 31: gramophile.ListResponse.elements:type_name -> gramophile.QueueElement
	33, // 32: gramophile.StoredUser.auth:type_name -> gramophile.GramophileAuth
	78, // 33: gramophile.StoredUser.user:type_name -> discogs.User
	79, // 34: gramophile.StoredUser.config:type_name -> gramophile.GramophileConfig
	80, // 35: gramophile.StoredUser.folders:type_name -> discogs.Folder
	81, // 36: gramophile.StoredUser.moves:type_name -> gramophile.FolderMove
	35, // 37: gramophile.UserLoginAttempts.attempts:type_name -> gramophile.UserLoginAttempt
	33, // 38: gramophile.GetLoginResponse.auth:type_name -> gramophile.GramophileAuth
	79, // 39: gramophile.SetConfigRequest.config:type_name -> gramophile.GramophileConfig
	10, // 40: gramophile.SetIntentRequest.intent:type_name -> gramophile.Intent
	48, // 41: gramophile.GetRecordRequest.get_record_with_issue:type_name -> gramophile.GetRecordWithIssue
	49, // 42: gramophile.GetRecordRequest.get_record_to_listen_to:type_name -> gramophile.GetRecordToListenTo
	47, // 43: gramophile.GetRecordRequest.get_record_with_id:type_name -> gramophile.GetRecordWithId
	8,  // 44: gramophile.GetRecordResponse.record:type_name -> gramophile.Record
	8,  // 45: gramophile.GetRecordResponse.records:type_name -> gramophile.Record
	82, // 46: gramophile.GetOrgResponse.snapshot:type_name -> gramophile.OrganisationSnapshot
	0,  // 47: gramophile.AddWantlistRequest.type:type_name -> gramophile.WantlistType
	6,  // 48: gramophile.GetWantsResponse.wants:type_name -> gramophile.Want
	4,  // 49: gramophile.GetWantlistResponse.list:type_name -> gramophile.Wantlist
	32, // 50: gramophile.GetUserResponse.user:type_name -> gramophile.StoredUser
	32, // 51: gramophile.GetUsersResponse.users:type_name -> gramophile.StoredUser
	28, // 52: gramophile.QueueService.Enqueue:input_type -> gramophile.EnqueueRequest
	28, // 53: gramophile.QueueService.Execute:input_type -> gramophile.EnqueueRequest
	30, // 54: gramophile.QueueService.List:input_type -> gramophile.ListRequest
	36, // 55: gramophile.GramophileEService.GetURL:input_type -> gramophile.GetURLRequest
	38, // 56: gramophile.GramophileEService.GetLogin:input_type -> gramophile.GetLoginRequest
	67, // 57: gramophile.GramophileEService.GetUser:input_type -> gramophile.GetUserRequest
	40, // 58: gramophile.GramophileEService.GetState:input_type -> gramophile.GetStateRequest
	42, // 59: gramophile.GramophileEService.SetConfig:input_type -> gramophile.SetConfigRequest
	44, // 60: gramophile.GramophileEService.SetIntent:input_type -> gramophile.SetIntentRequest
	46, // 61: gramophile.GramophileEService.GetRecord:input_type -> gramophile.GetRecordRequest
	51, // 62: gramophile.GramophileEService.GetOrg:input_type -> gramophile.GetOrgRequest
	53, // 63: gramophile.GramophileEService.SetOrgSnapshot:input_type -> gramophile.SetOrgSnapshotRequest
	63, // 64: gramophile.GramophileEService.AddWant:input_type -> gramophile.AddWantRequest
	59, // 65: gramophile.GramophileEService.GetWants:input_type -> gramophile.GetWantsRequest
	61, // 66: gramophile.GramophileEService.DeleteWant:input_type -> gramophile.DeleteWantRequest
	55, // 67: gramophile.GramophileEService.AddWantlist:input_type -> gramophile.AddWantlistRequest
	65, // 68: gramophile.GramophileEService.GetWantlist:input_type -> gramophile.GetWantlistRequest
	57, // 69: gramophile.GramophileEService.UpdateWantlist:input_type -> gramophile.UpdateWantlistRequest
	69, // 70: gramophile.GramophileService.GetUsers:input_type -> gramophile.GetUsersRequest
	71, // 71: gramophile.GramophileService.DeleteUser:input_type -> gramophile.DeleteUserRequest
	73, // 72: gramophile.GramophileService.Clean:input_type -> gramophile.CleanRequest
	29, // 73: gramophile.QueueService.Enqueue:output_type -> gramophile.EnqueueResponse
	29, // 74: gramophile.QueueService.Execute:output_type -> gramophile.EnqueueResponse
	31, // 75: gramophile.QueueService.List:output_type -> gramophile.ListResponse
	37, // 76: gramophile.GramophileEService.GetURL:output_type -> gramophile.GetURLResponse
	39, // 77: gramophile.GramophileEService.GetLogin:output_type -> gramophile.GetLoginResponse
	68, // 78: gramophile.GramophileEService.GetUser:output_type -> gramophile.GetUserResponse
	41, // 79: gramophile.GramophileEService.GetState:output_type -> gramophile.GetStateResponse
	43, // 80: gramophile.GramophileEService.SetConfig:output_type -> gramophile.SetConfigResponse
	45, // 81: gramophile.GramophileEService.SetIntent:output_type -> gramophile.SetIntentResponse
	50, // 82: gramophile.GramophileEService.GetRecord:output_type -> gramophile.GetRecordResponse
	52, // 83: gramophile.GramophileEService.GetOrg:output_type -> gramophile.GetOrgResponse
	54, // 84: gramophile.GramophileEService.SetOrgSnapshot:output_type -> gramophile.SetOrgSnapshotResponse
	64, // 85: gramophile.GramophileEService.AddWant:output_type -> gramophile.AddWantResponse
	60, // 86: gramophile.GramophileEService.GetWants:output_type -> gramophile.GetWantsResponse
	62, // 87: gramophile.GramophileEService.DeleteWant:output_type -> gramophile.DeleteWantResponse
	56, // 88: gramophile.GramophileEService.AddWantlist:output_type -> gramophile.AddWantlistResponse
	66, // 89: gramophile.GramophileEService.GetWantlist:output_type -> gramophile.GetWantlistResponse
	58, // 90: gramophile.GramophileEService.UpdateWantlist:output_type -> gramophile.UpdateWantlistResponse
	70, // 91: gramophile.GramophileService.GetUsers:output_type -> gramophile.GetUsersResponse
	72, // 92: gramophile.GramophileService.DeleteUser:output_type -> gramophile.DeleteUserResponse
	74, // 93: gramophile.GramophileService.Clean:output_type -> gramophile.CleanResponse
