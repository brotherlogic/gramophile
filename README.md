...
## Features
- LocateRecord: Provides functionality to query the location of records within the collection via the `gram locate` CLI command, displaying the artist name along with the title.
